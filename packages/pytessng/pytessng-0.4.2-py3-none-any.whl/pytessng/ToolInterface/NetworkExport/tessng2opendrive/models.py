...
from pytessng.ToolInterface.public.Line.LinkPointsSimplifier import PointsSimplifier
...
class BaseRoad:
    ...
    def calc_geometry_line(self, points, simplify_distance=0.3):
        ...
        selected_index = PointsSimplifier.simplify_points(points, simplify_distance)
...
class Connector(BaseRoad):
    def __init__(self, laneConnector, junction, qtpoint2point):
        ...
        self.tess_id = f"{self.fromLink.id()}_{self.toLink.id()}"
