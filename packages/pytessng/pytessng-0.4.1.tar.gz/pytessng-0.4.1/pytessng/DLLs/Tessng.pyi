...
class CustomerSimulator(Shiboken.Object):
    ...
    def recoveredSnapshot(self) -> None: ...
...
class ILaneObject(Shiboken.Object):
    ...
    def predecessor(self, id:int=...) -> Tessng.ILaneObject: ...
    def successor(self, id:int=...) -> Tessng.ILaneObject: ...
...
class ISection(Shiboken.Object):
    ...
    def length(self) -> float: ...
    def predecessor(self, id:int=...) -> Tessng.ISection: ...
    def sectionId(self) -> int: ...
    def successor(self, id:int=...) -> Tessng.ISection: ...
...
class NetInterface(Shiboken.Object):
    ...
    def updateLink(self, link:Tessng._Link) -> Tessng.ILink: ...
