class CommandLine(object):
    ...
    def __init__(self, line=""):
        self.keywords = [Keyword(key) for key in line.split()]
    ...
    def __getitem__(self, keywordname):
        for key in self.keywords:
            if key.keyword == keywordname:
                return key
        raise IndexError

    def add_keyword(self, keywordstr):
        """
...
class Keyword(object):
    ...
    def __getitem__(self, modifiername):
    ...
    def add_modifier(self, modifierstr):
        """
    ...
    def remove_modifier(self, modifiername):
        """
...
class Modifier(object):
    ...
    def __init__(self, modifier_string):
        self._name = None
        self._val = None

        self._parse(modifier_string)

    def _parse(self, modifier_string):
