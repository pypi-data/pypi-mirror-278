...
class GaussianLog(object):
    ...
    def write_gro_and_xtc(self, out_basename, box=None, resname='mlog',
                          find_energy_minima=False, numbered_names=False, 
                          bond_scan=None):
        """
    ...
    def filter_optimization_steps(self, find_energy_minima=False,
                                  bond_scan=None):
        """
        ...
        if find_energy_minima:
            filter_steps = energy_minima(filter_steps)
        if bond_scan is not None:
            filter_steps = scan_configurations(filter_steps, bond_scan)
        return filter_steps


def energy_minima(optimization_steps):
    """
...
def scan_configurations(optimization_steps, atoms_index):
    """
