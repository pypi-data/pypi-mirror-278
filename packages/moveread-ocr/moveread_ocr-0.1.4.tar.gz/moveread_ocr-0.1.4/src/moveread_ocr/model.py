...
def ChessCRNN(
  ...
  return keras.Sequential([
    kl.Input(shape=(256, 64, 1), batch_size=batch_size, name='image'),
...
def AdaptedChessCRNN(base: keras.Model, num_classes: int) -> keras.Model:
  ...
  return keras.Sequential([
    ...
    kl.Reshape((11, -1)),
    kl.Bidirectional(kl.LSTM(512, return_sequences=True, dropout=0.25), name="BiLSTM1"),
    kl.Bidirectional(kl.LSTM(512, return_sequences=True, dropout=0.25), name="BiLSTM2"),
    kl.Dense(num_classes, activation=None, name="dense")
  ], name="finetuned2")