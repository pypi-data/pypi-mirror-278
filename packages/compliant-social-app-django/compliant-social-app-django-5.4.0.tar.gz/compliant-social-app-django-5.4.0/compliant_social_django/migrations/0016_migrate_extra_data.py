...
def migrate_json_field(apps, schema_editor):
    UserSocialAuth = apps.get_model("compliant_social_django", "UserSocialAuth")
    Partial = apps.get_model("compliant_social_django", "Partial")
...
class Migration(migrations.Migration):
    # dependencies = [
    #     ("compliant_social_django", "0012_usersocialauth_extra_data_new"),
    # ]
    dependencies = [
        ("compliant_social_django", "0015_usersocialauth_extra_data_new"),
    ]
