...
class Letters_In_Image:
    ...
    def find_x_intersection(self):
        ...
        while not(flag) and (index1 < len(self.letters) - 1):
            ...
            while not(flag) and (index2 < len(self.letters)):
                if self.letters[index1].equal_x_for_percent(self.letters[index2], 0.6):
                    flag = True
                index2 += 1
            index1 += 1
    ...
    def delete_x_intersections(self):
        ...
        while flag:
            if flag:
                if (self.letters[index1].xmax - self.letters[index1].xmin) < (self.letters[index2].xmax - self.letters[index2].xmin):
