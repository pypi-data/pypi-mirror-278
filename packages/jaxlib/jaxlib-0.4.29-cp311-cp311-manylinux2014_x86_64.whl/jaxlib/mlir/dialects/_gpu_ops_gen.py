...
class GPUModuleOp(_ods_ir.OpView):
  ...
  def __init__(self, *, targets=None, offloadingHandler=None, loc=None, ip=None):
    operands = []
    results = []
    attributes = {}
    regions = None
...
def module(*, targets=None, offloading_handler=None, loc=None, ip=None) -> _ods_ir.Operation:
  return _get_op_result_or_op_results(GPUModuleOp(targets=targets, offloadingHandler=offloading_handler, loc=loc, ip=ip))
