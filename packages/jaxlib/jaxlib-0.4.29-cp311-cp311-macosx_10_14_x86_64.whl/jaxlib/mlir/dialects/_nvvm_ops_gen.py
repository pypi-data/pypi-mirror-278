...
@_ods_cext.register_operation(_Dialect)
class GridInClusterDimXOp(_ods_ir.OpView):
...
def read_ptx_sreg_cluster_nctaid_x(res, *, loc=None, ip=None) -> _ods_ir.Value:
  return _get_op_result_or_op_results(GridInClusterDimXOp(res=res, loc=loc, ip=ip))

@_ods_cext.register_operation(_Dialect)
class GridInClusterDimYOp(_ods_ir.OpView):
...
def read_ptx_sreg_cluster_nctaid_y(res, *, loc=None, ip=None) -> _ods_ir.Value:
  return _get_op_result_or_op_results(GridInClusterDimYOp(res=res, loc=loc, ip=ip))

@_ods_cext.register_operation(_Dialect)
class GridInClusterDimZOp(_ods_ir.OpView):
...
def read_ptx_sreg_cluster_nctaid_z(res, *, loc=None, ip=None) -> _ods_ir.Value:
  return _get_op_result_or_op_results(GridInClusterDimZOp(res=res, loc=loc, ip=ip))
