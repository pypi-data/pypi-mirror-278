...
"""
This module provides a general response class for FOS services.
"""
...
class FosResponse(object):
    ...
    def set_metadata_from_headers(self, headers):
        ...
        for k, v in iteritems(headers):
            if k.startswith(compat.convert_to_string(http_headers.FOS_PREFIX)):
                k = 'fos_' + k[len(compat.convert_to_string(http_headers.FOS_PREFIX)):]
