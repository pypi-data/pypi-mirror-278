...
"""
This module defines a common configuration class for FOS.
"""

from future.utils import iteritems

import flymeyun_fos.region
from flymeyun_fos import compat
from flymeyun_fos.retry.retry_policy import BackOffRetryPolicy


class FosClientConfiguration(object):
    """Configuration of Fos client."""
...
DEFAULT_PROTOCOL = flymeyun_fos.protocol.HTTP
DEFAULT_REGION = flymeyun_fos.region.BEIJING
DEFAULT_CONNECTION_TIMEOUT_IN_MILLIS = 50 * 1000
DEFAULT_SEND_BUF_SIZE = 1024 * 1024
DEFAULT_RECV_BUF_SIZE = 10 * 1024 * 1024
DEFAULT_CONFIG = FosClientConfiguration(
