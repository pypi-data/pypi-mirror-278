...
"""
This module defines exceptions for FOS.
"""
...
class FosClientError(FosError):
    """Error from FOS client."""
    def __init__(self, message):
        FosError.__init__(self, message)


class FosServerError(FosError):
    """Error from FOS servers."""
...
class FosHttpClientError(FosError):
