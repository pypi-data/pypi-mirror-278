#  pyrozee - Telegram MTProto API Client Library for Python
#  Copyright (C) 2017-present Dan <https://github.com/delivrance>
#  Copyright (C) 2022-present Mayuri-Chan <https://github.com/Mayuri-Chan>
#  Copyright (C) 2024-present eyMarv <https://github.com/eyMarv>
#
#  This file is part of pyrozee.
#
#  pyrozee is free software: you can redistribute it and/or modify
#  it under the terms of the GNU Lesser General Public License as published
#  by the Free Software Foundation, either version 3 of the License, or
#  (at your option) any later version.
#
#  pyrozee is distributed in the hope that it will be useful,
#  but WITHOUT ANY WARRANTY; without even the implied warranty of
#  MERCHANTABILITY or FITNESS FOR A PARTICULAR PURPOSE.  See the
#  GNU Lesser General Public License for more details.
#
#  You should have received a copy of the GNU Lesser General Public License
#  along with pyrozee.  If not, see <http://www.gnu.org/licenses/>.
...
class Client(Methods):
    """pyrozee Client, the main means for interacting with Telegram.
    ...
    Parameters:
        ...
        workdir (``str``, *optional*):
            ...
            The working directory is the location in the filesystem where pyrozee will store the session files.
    ...
    APP_VERSION = f"pyrozee {__version__}"
    ...
    async def authorize(self) -> User:
        ...
        print(f"Welcome to pyrozee (version {__version__})")
        print(
            f"pyrozee is free software and comes with ABSOLUTELY NO WARRANTY. Licensed\n"
        ...
        if session_empty:
            if not self.api_id or not self.api_hash:
                raise AttributeError(
                    ...
                    "More info: https://eyMarv.github.io/pyrozee-docs/start/auth"
                )
