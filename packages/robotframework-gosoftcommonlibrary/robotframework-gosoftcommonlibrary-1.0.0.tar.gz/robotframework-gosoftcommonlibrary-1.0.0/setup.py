...
with open('src/GosoftCommonLibrary/version.py', 'r') as version_file:
...
setup(
    name='robotframework-gosoftcommonlibrary',
    version=VERSION,
    description="Gosoft Common Library For Robot framework",
    author="Watchagorn Pattummee",
    author_email='watchagornpat@gosoft.co.th',
    url='https://gitlab.com/watchagorn/gosoftrobotframeworklibrary',
    ...
    zip_safe=False,
    keywords='GosoftWebCommon, GosoftCommon, GosoftAppCommon,GosoftCommonLibrary',
