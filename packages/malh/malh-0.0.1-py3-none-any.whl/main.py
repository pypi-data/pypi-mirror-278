...
task_dict = TaskDictionary()

print(task_dict.find("сумму"))
print(task_dict.find("факториал"))
print(task_dict.find("максимальное"))
print(task_dict.find("палиндром"))
print(task_dict.find("НОД"))
