...
'''缺少差错检测、文件处理与工作模式'''
'''仍需要加的补丁：解密输入目前只有十六进制字符串，是否可加入字节？'''
class SM4Cipher:
...
class RSA:
    ...
    def __init__(self,w:int):
        ...
        self.e=self.get_e(self.phi,w)
        self.d=Era(self.e,self.N)
    def Get_Public_Key(self):
        return self.N,self.e
    def Get_Secret_Key(self):
        return self.prime,self.d
    def encrypt(e:int,m:int,N:int):
        return fast_times(N,m,e)
...
'''
w='我说你爸爸'
w='8a4de98e159b3034f8bac5acee46a0d6'
#w='9cc7301fca20b5aa43ee658c54553fa4'
#w='3482a9148515b024286e37605227e109203b56d54f910514fdb09ce79a68dac7cc390599ebf5a3e56b8806cf726850fd'
key='7dfee2f716c4c4cd5217f0d57c75c2d7'
IV='a8638d2fb23cc49206edd7c84532eaab'
IV=bytes.fromhex(IV)
key=bytes.fromhex(key)
sm4=SM4Cipher(key)
sm4.CBC_Import(IV)
res=sm4.decrypt(w,'CBC')
print(res,bytes.fromhex(res).decode('utf-8'))
#print(n2s(int(res,16)).decode('utf-8'))
#e68891e8afb4e4bda0e788b8e788b801
'''