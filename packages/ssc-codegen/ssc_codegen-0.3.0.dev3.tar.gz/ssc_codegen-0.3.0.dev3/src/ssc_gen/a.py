...
T_EpisodePage = TypedDict(
    "T_EpisodePage",
    {"dubbers": T_EpisodeDubbersView, "episodes": List["T_EpisodesView"]},
)
...
T_SourcePage = TypedDict(
    "T_SourcePage",
    {"dubbers": T_SourceDubbersView, "videos": List["T_SourceVideoView"]},
)
...
class AnimePage(BaseParser):
    ...
    def _parse_description(self, el):
        ...
        var_3 = self._re_sub(var_2, "^\\s+", "")
        var_4 = self._re_sub(var_3, "\\s+$", "")
        return var_4
        ...
        return [
            T_SourceVideoView(
                **{
                    ...
                    "data_provide_dubbing": self._parse_data_provide_dubbing(
                        el
                    ),
                }
            )
