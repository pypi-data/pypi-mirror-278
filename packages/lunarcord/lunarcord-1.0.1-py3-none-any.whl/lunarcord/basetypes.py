...
class Message:
    ...
    async def send(self, *content: str, reference: Message = None, embed: Embed = None, embeds: list = None, attachments: list = [], view: View | str = None, button: Button = None, buttons: list[Button] = []):
        '''
...
class Channel:
    ...
    async def send(self, *content: str, reference: int = None, embed: Embed = None, embeds: list = [], attachments: list = [], view: View | str = None, button: Button = None, buttons: list[Button] = []) -> Message:
        '''
        ...
        content = " ".join([x for x in str(content)])
