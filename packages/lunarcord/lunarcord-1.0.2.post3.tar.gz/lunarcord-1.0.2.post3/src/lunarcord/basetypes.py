...
class Message:
    ...
    def send(self, *content: str, reference: Message = None, embed: Embed = None, embeds: list = None, attachments: list = [], view: View | str = None, button: Button = None, buttons: list[Button] = []):
        '''
