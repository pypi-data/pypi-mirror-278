...
def _uniffi_check_api_checksums(lib):
    if lib.uniffi_ceylon_checksum_func_add() != 13202:
...
_UniffiLib.uniffi_ceylon_fn_func_add.argtypes = (
    ctypes.c_uint32,
    ctypes.c_uint32,
    ctypes.POINTER(_UniffiRustCallStatus),
)
_UniffiLib.uniffi_ceylon_fn_func_add.restype = ctypes.c_uint32
...
_UniffiLib.uniffi_ceylon_checksum_func_add.argtypes = (
)
_UniffiLib.uniffi_ceylon_checksum_func_add.restype = ctypes.c_uint16
...
def add(a: "int",b: "int") -> "int":
    ...
    return _UniffiConverterUInt32.lift(_rust_call(_UniffiLib.uniffi_ceylon_fn_func_add,
