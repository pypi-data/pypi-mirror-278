...
def _uniffi_check_api_checksums(lib):
    ...
    if lib.uniffi_ceylon_checksum_method_agentcore_broadcast() != 16942:
        raise InternalError("UniFFI API checksum mismatch: try cleaning and rebuilding your project")
    ...
    if lib.uniffi_ceylon_checksum_method_agentcore_workspace_id() != 28110:
        raise InternalError("UniFFI API checksum mismatch: try cleaning and rebuilding your project")
    if lib.uniffi_ceylon_checksum_method_messagehandler_on_message() != 57067:
        raise InternalError("UniFFI API checksum mismatch: try cleaning and rebuilding your project")
    if lib.uniffi_ceylon_checksum_method_processor_run() != 5857:
        raise InternalError("UniFFI API checksum mismatch: try cleaning and rebuilding your project")
...
UNIFFI_CALLBACK_INTERFACE_PROCESSOR_METHOD0 = ctypes.CFUNCTYPE(None,ctypes.c_uint64,UNIFFI_FOREIGN_FUTURE_COMPLETE_VOID,ctypes.c_uint64,ctypes.POINTER(UniffiForeignFuture),
)
...
class MessageHandler(typing.Protocol):
    def on_message(self, agent_id: "str",message: "str"):
        raise NotImplementedError
...
class MessageHandlerImpl:
    ...
    async def on_message(self, agent_id: "str",message: "str") -> None:
...
class UniffiTraitImplMessageHandler:
    ...
    def on_message(
        ...
        def make_call():
            args = (_UniffiConverterString.lift(agent_id), _UniffiConverterString.lift(message), )
