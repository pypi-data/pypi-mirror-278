...
def get_alerts(dataset_stats, series_descriptions):
    ...
    for col in series_descriptions.keys():
        alerts.extend(get_variable_alerts(series_descriptions[col]))
