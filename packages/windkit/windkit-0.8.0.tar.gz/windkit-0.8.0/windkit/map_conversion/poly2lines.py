...
from windkit.map_conversion._polygons_constraints import _complete_polygons_vertices
...
def poly2lines(poly_gdf, background_lc_id=None, atol=0, complete_polys=False):
