...
class Exception(Exception):
    ...
    def __init__(self, code: "peak_afl_status", get_text: "bool"=True):
        _ids_peak_afl_python_interface.Exception_swiginit(self, _ids_peak_afl_python_interface.new_Exception(code, get_text))

    def code(self) -> "peak_afl_status":
        r"""
        Get the return code for the failure

        :rtype: int
        :return: the return code
        """
        return _ids_peak_afl_python_interface.Exception_code(self)
    ...
    @staticmethod
    def translateCode(status: "peak_afl_status") -> "str":
        r"""
        Get a str representation for an error code

        :type status: int
        :param status: the status code of an exception
        :rtype: str
        :return: the str representation for that code
        """
        return _ids_peak_afl_python_interface.Exception_translateCode(status)
...
r""" Controller callback type processing data"""
