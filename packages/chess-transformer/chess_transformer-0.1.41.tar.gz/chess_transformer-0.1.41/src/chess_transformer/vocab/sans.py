...
def get_piece_sans(symbol: Literal["N", "B", "R", "Q"], *, with_full_discriminators: bool = True) -> Set[str]:
  """
...
def legal_sans(*, with_symbols: bool = False, with_full_discriminators: bool = True) -> list[str]:
