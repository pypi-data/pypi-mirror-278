...
import math
import json
from ccxt.base.types import Balances, Currencies, Currency, IndexType, Int, Market, Num, Order, OrderBook, OrderSide, OrderType, Str, Ticker, Tickers, Trade, TradingFeeInterface, Transaction
...
class cube(Exchange, ImplicitAPI):
    ...
    def cancel_order(self, id: str, symbol: Str = None, params={}):
        ...
        reason = None
        if response['result']['Rej'] is not None:
    ...
    def withdraw(self, code: str, amount: float, address: str, tag=None, params={}) -> Transaction:
        ...
        currencyPrecision = self.safe_integer(currency, 'precision')
        exchangeAmount = amount * math.pow(10, currencyPrecision)
        request = {
