...
class MskProvisioned(
    ...
    def update_zookepeer_function(self) -> _aws_cdk_aws_lambda_ceddda9d.IFunction:
        '''The Lambda function responsible for updating Zookeeper.'''
        return typing.cast(_aws_cdk_aws_lambda_ceddda9d.IFunction, jsii.get(self, "updateZookepeerFunction"))

    @builtins.property
    @jsii.member(jsii_name="updateZookepeerLogGroup")
    def update_zookepeer_log_group(self) -> _aws_cdk_aws_logs_ceddda9d.ILogGroup:
        '''The CloudWatch Log Group used by the Lambda responsible for updating Zookeeper.'''
        return typing.cast(_aws_cdk_aws_logs_ceddda9d.ILogGroup, jsii.get(self, "updateZookepeerLogGroup"))

    @builtins.property
    @jsii.member(jsii_name="updateZookepeerRole")
    def update_zookepeer_role(self) -> _aws_cdk_aws_iam_ceddda9d.IRole:
        '''The IAM Role used by the Lambda responsible for updating Zookeeper.'''
        return typing.cast(_aws_cdk_aws_iam_ceddda9d.IRole, jsii.get(self, "updateZookepeerRole"))

    @builtins.property
    @jsii.member(jsii_name="updateZookepeerSecurityGroup")
    def update_zookepeer_security_group(
        self,
    ) -> _aws_cdk_aws_ec2_ceddda9d.ISecurityGroup:
        '''THe Security Group associated to the Lambda responsible for updating Zookeeper.'''
        return typing.cast(_aws_cdk_aws_ec2_ceddda9d.ISecurityGroup, jsii.get(self, "updateZookepeerSecurityGroup"))
