...
--------------------------------------------------------------------------------
   USAGE:
--------------------------------------------------------------------------------
$python3 compute_XY_maps_gaiaXPSP.py *field_list_file* *config_file* *save_file* nx ny
...
def fix_XY_rotation():
    ...
    for field in fields:
        ...
        # In case of shorts, no xy rotation is computed
        if conf['shorts']:
            xy_rotation_name = f"shorts_x0y0l.csv"
            xy_rotation_file = os.path.join(pipeline_path, 'steps', 'resources',
                                            xy_rotation_name)
