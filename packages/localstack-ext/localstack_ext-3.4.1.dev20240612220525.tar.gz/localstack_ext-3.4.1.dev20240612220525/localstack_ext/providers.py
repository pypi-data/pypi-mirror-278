...
def dms():from localstack_ext.services.dms.provider import DmsProvider as A;B=A();return Service.for_provider(B)
@pro_aws_provider()
...
@pro_aws_provider(api=_C,name=_B)
...
@pro_aws_provider(api=_F,name=_G)
def events_v1():from localstack_ext.services.events.provider import EventsProviderPro as A;B=A();return Service.for_provider(B,dispatch_table_factory=MotoFallbackDispatcher)
...
@pro_aws_provider(api=_D,name=_G)
...
def textract():from localstack.services.moto import MotoFallbackDispatcher as A;from localstack_ext.services.textract.provider import TextractProvider as B;C=B();return Service.for_provider(C,dispatch_table_factory=A)
