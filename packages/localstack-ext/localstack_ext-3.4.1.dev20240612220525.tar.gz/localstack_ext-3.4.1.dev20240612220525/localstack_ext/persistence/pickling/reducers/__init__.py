...
def register():
    ...
    import localstack_ext.persistence.pickling  # noqa
    import localstack_ext.persistence.pickling.reducers.botocore  # noqa
    import localstack_ext.persistence.pickling.reducers.cryptography  # noqa
    import localstack_ext.persistence.pickling.reducers.stdlib  # noqa
    import localstack_ext.persistence.pickling.reducers.services.acm  # noqa
