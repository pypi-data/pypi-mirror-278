...
class ParallelismConfiguration(TypedDict, total=False):
    ...
    Execution <https://nightlies.apache.org/flink/flink-docs-release-1.18/dev/parallel.html>`__
    in the `Apache Flink
    Documentation <https://nightlies.apache.org/flink/flink-docs-release-1.18/>`__.
    """
...
class CheckpointConfiguration(TypedDict, total=False):
    ...
    Tolerance <https://nightlies.apache.org/flink/flink-docs-release-1.18/docs/dev/datastream/fault-tolerance/checkpointing/#enabling-and-configuring-checkpointing>`__
    in the `Apache Flink
    Documentation <https://nightlies.apache.org/flink/flink-docs-release-1.18/>`__.
    """
