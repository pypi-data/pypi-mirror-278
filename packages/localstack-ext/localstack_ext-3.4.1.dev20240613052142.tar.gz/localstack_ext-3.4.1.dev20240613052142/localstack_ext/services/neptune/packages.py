_C='d4531b134ba86f2a5603442e7e6de17d2296be32'
_B='3.5.2'
_A='3.6.2'
import logging,os
...
import localstack_ext.config as config_ext
...
TINKERPOP_ID_MANAGER_COMMIT=_C
TINKERPOP_PATCH_COMMIT=_C
...
TINKERPOP_PATCHED_VERSIONS=[_A,'3.7.2']
...
NEPTUNE_TRANSACTION_VERSION='3.7.2'
TINKERPOP_VERSION_SUPPORT_NEPTUNE={'1.1.0.0':'3.4.11','1.1.1.0':_B,'1.2.0.0':_B,'1.2.0.1':_B,'1.2.0.2':_B,'1.2.1.0':_A,'1.2.1.1':_A,'1.3.0.0':_A,'1.3.1.0':_A}
