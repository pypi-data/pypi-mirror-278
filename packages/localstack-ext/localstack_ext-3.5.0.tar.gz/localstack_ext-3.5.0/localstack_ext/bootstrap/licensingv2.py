...
from localstack_ext.constants import PLATFORM_PLUGIN_NAMESPACE
...
class LicenseV1Client(LicenseV1ClientBase):
	...
	def _get_product_data(B):from localstack_ext.constants import VERSION as A;return{_E:'localstack-pro',_F:A}
