            ...
            if self .overlayPlotsCheckBox .isChecked ():
                ...
                if 'Scatter plot dI vs dt'in plotType and 'ln'not in plotType :
                    ...
                    for filePath ,values in plotData .items ():
                        ...
                        ax .hist (log_values ,bins =self .histogramBinsSpinBox .value (),range =(np .log (min_x ),np .log (max_x )),alpha =alpha ,label =label ,density =True )
                    fig .tight_layout ()
                    ax .legend ()
                ...
                for filePath ,values in plotData .items ():
                    ...
                    if 'Scatter plot dI vs dt'in plotType and 'ln'not in plotType :
                        ...
                        log_values =np .log (values [values >0 ])
                        axes_dict =self .create_histogram (fig ,log_values ,np .log (min_x ),np .log (max_x ),'dt (ln)',alpha )
                        canvas .axes_dict =axes_dict 
