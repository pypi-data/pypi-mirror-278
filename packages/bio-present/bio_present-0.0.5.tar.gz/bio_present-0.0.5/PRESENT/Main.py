...
def PRESENT_function(
    ...
    embeddings, omics_lat, omics_impute = model.model_train(spa_mat=spatial_mtx, 
                                                            rna_counts=adata_rna.X, ref_rna_counts=ref_rna_counts, ref_rna_anno=rdata_rna_anno,
                                                            cas_counts=adata_atac.X, ref_cas_counts=ref_cas_counts, ref_cas_anno=rdata_atac_anno,
                                                            adt_counts=adata_adt.X, ref_adt_counts=ref_adt_counts, ref_adt_anno=rdata_adt_anno,
                                                            impute=False,
