    ...
    def decorator(func):
        def wrapper(*args, **kwargs):
            ...
            if library == "matplotlib":
                ...
                return [_get_html_from_mpl_image(result, "html"), _get_html_from_mpl_image(result, "png")]
            elif library == "plotly":
                assert isinstance(result, plotly.graph_objs._figure.Figure)
                return [_get_html_from_plotly_image(result, "html"), _get_html_from_plotly_image(result, "png")]
            else:
