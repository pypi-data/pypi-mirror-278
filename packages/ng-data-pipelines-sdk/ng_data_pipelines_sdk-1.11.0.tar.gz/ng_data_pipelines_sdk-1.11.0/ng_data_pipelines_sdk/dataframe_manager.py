...
class DataFrameManager:
    ...
    def read_input_dataframes_params(
        ...
        def retry_read_dataframe_previous_dates(
            ...
            logger.warning(
                f"Max retries reached. No data found for the last {max_retries + 1} dates."
            )
            return None
        ...
        for df_name, input_df_params in input_df_params_dict.items():
            ...
            if df is not None:
                ...
                logger.warning(
                    f"Dataframe '{df_name}' is empty. It will not be added to the dictionary, and any functions that reference it will fail."
                )
        return dfs
