...
def stream7(
    ...
    """
    Streaming version of predict7
    Returns:
        generator that returns a tuple of (node, message str) at each round
    """
    query = args['question']
    ...
    while 'final_answer' not in current_tools and iter < MAX_ITERATION: 
        ...
        # post-condition: history = [AI1, Tool1]
        tool_output = execute_tools([initial,])
        yield (execute_tools, tool_output)
