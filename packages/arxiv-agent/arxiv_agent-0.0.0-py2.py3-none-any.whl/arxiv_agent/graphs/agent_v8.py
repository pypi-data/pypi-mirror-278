...
# # v4.2 with only the student 
# # previous version where the Notes is in the system prompt
# def predict8_(
...
#     history = get_by_session_id(session_id) # history = [Ins, AI1]
#     # record token info
...
#     while 'final_answer' not in current_actions and num_iterations < MAX_ITERATION:
...
#             {"messages": history, "question": question, "Notes": str(List_of_Notes[:-1]), "instructions": actor_instructions},
#             config={"configurable": {"session_id": session_id}}
