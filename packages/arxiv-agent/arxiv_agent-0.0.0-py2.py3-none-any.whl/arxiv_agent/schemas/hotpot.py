...
class Answer_w_Notes(BaseModel):
    ...
    Notes: str = Field(
        description="""Write a one sentence note for your future self to summarize if your last action and tool output was helpful in answering the question 
                        ...
                        Example: 
                        I used search_tool(entity); helpful; Although I did not find exact match, but I found similar pages which can provide helpful information.
                        I used lookup_tool(keyword); not helpful; because I didn't find relevant information.""")
