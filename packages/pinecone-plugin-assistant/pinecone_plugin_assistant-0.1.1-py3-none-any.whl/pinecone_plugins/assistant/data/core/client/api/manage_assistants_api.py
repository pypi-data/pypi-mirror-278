    ...
    def __init__(self, api_client=None):
        ...
        def __delete_file(
            ...
            **kwargs
            ...
            >>> thread = api.delete_file(assistant_name, kb_file_id, async_req=True)
            >>> result = thread.get()
        ...
        self.delete_file = _Endpoint(
            settings={
                ...
                'endpoint_path': '/assistant/files/{assistant_name}/{kb_file_id}',
        ...
        def __describe_file(
            ...
            **kwargs
            ...
            >>> thread = api.describe_file(assistant_name, kb_file_id, async_req=True)
            >>> result = thread.get()
