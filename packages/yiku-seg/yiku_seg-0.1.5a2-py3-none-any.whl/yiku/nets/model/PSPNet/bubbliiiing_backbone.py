...
def mobilenetv2(pretrained=False, **kwargs):
    ...
    if pretrained:
        if pretrained:
            model.load_state_dict(torch.load(WTS_STORAGE_DIR / f"mobilenet_v2.pth.tar"))
    return model
...
def resnet50(pretrained=False, **kwargs):
    ...
    if pretrained:
        model.load_state_dict(load_state_dict_from_url(model_urls['resnet50'], WTS_STORAGE_DIR), strict=False)
    return model