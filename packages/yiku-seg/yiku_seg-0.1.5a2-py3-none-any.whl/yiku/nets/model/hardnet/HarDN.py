...
class Encoder(nn.Module):
    ...
    def __init__(self, n_blocks, in_channels, ch_list, gr, grmul, n_layers):
        ...
        for i in range(n_blocks):
            ...
            self.blks.append(
                ConvBNReLU(
                    ch, ch_list[i], kernel_size=1, bias=False))
...
class HarDBlock(nn.Module):
    ...
    def __init__(self,
        ...
        for i in range(n_layers):
            ...
            layers_.append(
               ConvBNReLU(
                    inch, outch, kernel_size=3, bias=False))
...
class HarDNet(nn.Module):
    ...
    def __init__(self,
        ...
        self.stem = nn.Sequential(
            ConvBNReLU(
                in_channels, stem_channels[0], kernel_size=3, bias=False),
            ConvBNReLU(
                stem_channels[0],
                stem_channels[1],
                kernel_size=3,
...
def load_entire_model(model, pretrained):
    if pretrained is not None:
        ...
        print('Weights are not loaded for {} model since the '
