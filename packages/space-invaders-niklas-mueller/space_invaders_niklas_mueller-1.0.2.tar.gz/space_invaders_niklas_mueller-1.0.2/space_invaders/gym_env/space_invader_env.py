...
player_im_path = str(pkg_resources.files(space_invaders).joinpath('assets/player.png'))
blockade_im_path = str(pkg_resources.files(space_invaders).joinpath('assets/blockade.png'))


def load_assets() -> list[Any]:
    player_im = pygame.image.load(player_im_path)
    blockade_im = pygame.image.load(blockade_im_path)
    laser_im = pygame.image.load(laser_im_path)
