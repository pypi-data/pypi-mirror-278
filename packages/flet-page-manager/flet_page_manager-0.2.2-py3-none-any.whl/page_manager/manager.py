...
from typing import Generic, TypeVar, Any, Awaitable, Callable
...
class PageManager(Generic[__PageManager_StateT]):
    ...
    __PageManager_run_task_OutputT = TypeVar("__PageManager_run_task_OutputT")

    def run_task(self, handler: Callable[..., Awaitable[__PageManager_run_task_OutputT]], *args):
