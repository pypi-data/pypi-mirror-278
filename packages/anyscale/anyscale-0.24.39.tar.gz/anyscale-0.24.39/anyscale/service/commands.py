...
def terminate(name: Optional[str], *, _sdk: PrivateServiceSDK) -> str:
    """Terminate a service.
...
_STATUS_ARG_DOCSTRINGS = {"name": "Name of the service."}
...
def status(name: str, *, _sdk: PrivateServiceSDK) -> ServiceStatus:
