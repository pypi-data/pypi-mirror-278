...
from StudioPulse.app.utils import fields, date_helpers

from StudioPulse.app.services import user_service
from StudioPulse.app.services.exception import WrongDateFormatException
...
def get_year_table(
    person_id=None, project_id=None, department_ids=None, StudioPulse_id=None
):
    """
    ...
    return get_yearly_table(
        ...
        StudioPulse_id=StudioPulse_id,
    )


def get_month_table(
    year, person_id=None, project_id=None, department_ids=None, StudioPulse_id=None
):
    """
    Return a table giving time spent by user and by month for given year.
    """
