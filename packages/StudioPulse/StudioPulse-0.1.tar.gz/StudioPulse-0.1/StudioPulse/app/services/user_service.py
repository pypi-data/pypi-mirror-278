...
from StudioPulse.app.models.entity import Entity
...
from StudioPulse.app.utils import cache, fields, permissions
...
def get_context():
    ...
    StudioPulses = tasks_service.get_StudioPulses()
