...
swagger_template = {
    ...
    "externalDocs": {
        ...
        "url": "https://StudioPulse.cg-wire.com",
    },
    "host": "localhost:8080",
    "basePath": "/api",
    "schemes": ["http", "https"],
    ...
    "definitions": {
        ...
        "Person": {
            ...
            "properties": {
                ...
                "active": {
                    "type": "boolean",
                    "description": "True if the person is still in the StudioPulse, False otherwise",
                },
                "last_presence": {
                    "type": "string",
                    "format": "date",
                    "description": "Last time the person worked for the StudioPulse",
                },
        ...
        "StudioPulse": {
            ...
            "properties": {
                "name": {
                    "type": "string",
                    "description": "Name of StudioPulse",
                },
                "color": {
                    "type": "string",
                    "description": "Color of StudioPulse",
                },
                "archived": {
                    "type": "boolean",
                    "description": "True if the StudioPulse is archived else False",
                },
            },
        },
        "Task": {
