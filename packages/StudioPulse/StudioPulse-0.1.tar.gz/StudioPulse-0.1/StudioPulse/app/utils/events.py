...
from StudioPulse.app.stores import publisher_store
from StudioPulse.app.models.event import ApiEvent
from StudioPulse.app.utils import fields
...
def emit(event, data={}, persist=True, project_id=None):
    ...
    from StudioPulse.app.config import ENABLE_JOB_QUEUE
...
def save_event(event, data, project_id=None):
    ...
    """
    try:
        from StudioPulse.app.services.persons_service import (
