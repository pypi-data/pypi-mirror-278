...
from StudioPulse.app.utils import permissions, shell, date_helpers
from StudioPulse.app.services import projects_service, stats_service
...
class StatusResourcesResource(BaseStatusResource):
    def get(self):
        ...
        if config.ENABLE_JOB_QUEUE:
            from StudioPulse.app.stores.queue_store import job_queue
