...
from StudioPulse.app.utils import dbhelpers
from StudioPulse.app.utils.env import envtobool, env_with_semicolon_to_list
...
DATABASE = {
    ...
    "database": os.getenv("DB_DATABASE", "StudioPulsedb"),
}
...
TMP_DIR = os.getenv("TMP_DIR", os.path.join(tempfile.gettempdir(), "StudioPulse"))
...
MAIL_DEFAULT_SENDER = os.getenv(
    "MAIL_DEFAULT_SENDER", "no-reply@your-StudioPulse.com"
)
...
JOB_QUEUE_NOMAD_PLAYLIST_JOB = os.getenv(
    "JOB_QUEUE_NOMAD_PLAYLIST_JOB", "StudioPulse-playlist"
)
JOB_QUEUE_NOMAD_NORMALIZE_JOB = os.getenv("JOB_QUEUE_NOMAD_NORMALIZE_JOB", "")
JOB_QUEUE_NOMAD_HOST = os.getenv("JOB_QUEUE_NOMAD_HOST", "StudioPulse-nomad-01.StudioPulse")
...
LDAP_BASE_DN = os.getenv("LDAP_BASE_DN", "cn=Users,dc=StudioPulse,dc=local")
LDAP_GROUP = os.getenv("LDAP_GROUP", "")
LDAP_DOMAIN = os.getenv("LDAP_DOMAIN", "StudioPulse.local")
