...
from StudioPulse.app import config, swagger
...
from StudioPulse.app.utils import cache, fs, logs, monitoring
from StudioPulse.app.utils.flask import (
    ParsedUserAgent,
    ORJSONProvider,
    wrong_auth_handler,
)
...
def configure_auth():
    from StudioPulse.app.services import persons_service
    from StudioPulse.app.services.auth_service import logout
...
def load_api(app):
    from StudioPulse.app import api
