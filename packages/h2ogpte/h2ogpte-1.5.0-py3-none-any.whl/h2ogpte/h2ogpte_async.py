...
from h2ogpte.utils import import_pymupdf
...
class H2OGPTEAsync:
        ...
        Args:
            ...
            llm_args:
                Dictionary of kwargs to pass to the llm. Valid keys:
                    ...
                    guided_grammar (str, default: "") — If specified, the output will follow the context free grammar.
                    guided_whitespace_pattern (str, default: "") — If specified, will override the default whitespace pattern for guided json decoding.
                    enable_image (str, default: "auto") - Controls vision mode, send images to the LLM instead of text chunks. Only for LLMs that support vision, use get_visible_image_models() to see list. One of ["on", "off", "auto"].
            max_num_chunks:
            ...
            meta_data_to_include:
                A dictionary containing flags that indicate whether each piece of document metadata is to be included as part of the context given to the LLM. Only used if enable_image is disabled.
                Default is {
                    "name": True,
                    "text": True,
                    "page": True,
    ...
    async def get_visible_image_models(self) -> List[str]:
        """Lists names of available multi-modal LLMs (that can handle images as input) in the environment.

        Returns:
            list of string: Name of each available model.

        """
        return await self._lang("get_visible_image_models")
