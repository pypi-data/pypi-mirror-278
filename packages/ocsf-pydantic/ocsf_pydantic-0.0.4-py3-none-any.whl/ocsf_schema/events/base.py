...
from ocsf_schema.objects.cloud import Cloud
from ocsf_schema.objects.enrichment import Enrichment
from ocsf_schema.objects.metadata import Metadata
from ocsf_schema.objects.observable import Observable
