...
from ocsf_schema.objects.http_response import HTTPResponse

from ocsf_schema.objects.network_endpoint import NetworkEndpoint
from ocsf_schema.objects.tls import TLS
from ocsf_schema.objects.network_endpoint import NetworkProxy
from ocsf_schema.objects.web_resource import WebResource
