...
from ocsf_schema.objects.resource_details import ResourceDetails
from ocsf_schema.objects.api import API

from ocsf_schema.events.application import Application
