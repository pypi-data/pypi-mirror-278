...
class DBTraceObjectValue(object, ghidra.trace.model.target.TraceObjectValue):




    def __init__(self, __a0: ghidra.trace.database.target.DBTraceObjectManager, __a1: ghidra.trace.database.target.TraceObjectValueStorage): ...
    ...
    def getWrapped(self) -> ghidra.trace.database.target.TraceObjectValueStorage: ...
    ...
    @property
    def wrapped(self) -> ghidra.trace.database.target.TraceObjectValueStorage: ...