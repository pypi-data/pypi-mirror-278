...
T = TypeVar("T", bound="PaginatedAssistantList")


@_attrs_define
class PaginatedAssistantList:
    """
    Attributes:
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        paginated_assistant_list.additional_properties = d
        return paginated_assistant_list
