...
class Tracking(betterproto.Message):
    ...
    """
    How long the tracker needs to confirm a new object Reasonale default: 0.85
    """

    acceleration_noise: float = betterproto.float_field(2)
    """
    How fluctuating the acceleration of the objects is Reasonable default: 0.5
    """

    survival_probability: float = betterproto.float_field(3)
    """
    How long the tracker can wait for the next observation Reasonable default:
    1
    """
