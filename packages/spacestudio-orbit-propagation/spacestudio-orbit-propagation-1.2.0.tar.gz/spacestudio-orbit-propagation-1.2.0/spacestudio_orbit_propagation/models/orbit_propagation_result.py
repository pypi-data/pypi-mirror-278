...
class OrbitPropagationResult(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["deltaInclination", "deltaEccentricity", "deltaSemiMajorAxis", "missionDuration", "numberOfPeriods", "ephemerides", "fieldIndexes", "ephemeridesFrame", "errors", "warnings", "finalOrbit"]
