...
if selected_type == "Regression Models":
	...
	selected_models = st.multiselect("Select models to train", [key for key, model in models.items() if isinstance(model, (LogisticRegression, GradientBoostingClassifier, BaggingClassifier, AdaBoostClassifier, RandomForestClassifier, SVC, KNeighborsClassifier, DecisionTreeClassifier))])
