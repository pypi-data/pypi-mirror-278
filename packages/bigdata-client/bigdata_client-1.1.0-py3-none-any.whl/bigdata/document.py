...
from bigdata.api.knowledge_graph import ByIdsRequest, ByIdsRequestItem
from bigdata.api.search import ChunkedDocumentResponse
from bigdata.connection_protocol import BigdataConnectionProtocol
from bigdata.models.advanced_search_query import SectionMetadata, TranscriptTypes
...
class Document:
    ...
    section_metadata: Optional[str] = None
