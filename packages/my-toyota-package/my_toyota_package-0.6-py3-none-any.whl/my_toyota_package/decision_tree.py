...
import pkg_resources  # pkg_resources 모듈 임포트
...
def plot_decision_tree(model, feature_names, rotate=False):
    plt.figure(figsize=(20, 10))
    plot_tree(model, feature_names=feature_names, filled=True, rounded=True, class_names=['No', 'Yes'], rotate=rotate)
    plt.show()
