...
def create_combined_metrics_prom(directory: str):
    """
    Args:
...
def execute_commands_on_servers(servers, key_path, username, directory):
    """
    ...
    create_combined_metrics_prom(directory)
