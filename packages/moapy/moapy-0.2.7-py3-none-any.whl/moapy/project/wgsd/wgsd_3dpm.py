...
input = {
    ...
    "lcom": {
        "uls" : {
            "HEAD": ["name", "Fx", "My", "Mz"],
            "DATA": [["ULS1", 1000000000.0, 0.0, 8000000.0], ["ULS2", 1000000000.0, 8000000.0, 8000000.0]]
        },
        "sls" : {
            "HEAD": ["name", "Fx", "My", "Mz"],
            "DATA": [["SLS1", 1000000000.0, 0.0, 8000000.0], ["SLS2", 1000000000.0, 8000000.0, 8000000.0]]
        }
    },
    "dgncode": "ACI318M-19",
    "option": {
