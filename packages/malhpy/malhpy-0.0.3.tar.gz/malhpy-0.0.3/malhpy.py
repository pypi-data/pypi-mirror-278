    ...
    def __init__(self):
        self.tasks = {
            ...
            "новой формуле.Создать проект для демонстрации работы: ввод и вывод информации обобъектах классов":
                ...
                "class Car:"
                "def __init__(self, brand, power_kw, seats):"
                "self.brand = brand"
                "self.power_kw = power_kw"
                "self.seats = seats"
                "def quality(self):"
                "return 0.1 * self.power_kw * self.seats"
                "def display_info(self):"
                "print(f'Марка: {self.brand}, Мощность (кВт): {self.power_kw}, Количество мест: {self.seats}, Качество: {self.quality()}')"
                "class AdvancedCar(Car):"
                "def __init__(self, brand, power_kw, seats, year):"
                "super().__init__(brand, power_kw, seats)"
                "self.year = year"
                "def quality(self):"
                "T = datetime.now().year"
                "base_quality = super().quality()"
                "return base_quality - 1.5 * (T - self.year)"
                "def display_info(self):"
                "super().display_info()"
                "print(f'Год выпуска: {self.year}, Качество с учетом года выпуска: {self.quality()}')"
                "car1 = Car('Toyota', 100, 5)"
                "car2 = AdvancedCar('BMW', 150, 4, 2015)"
                "print('Информация о базовом автомобиле:')"
                "car1.display_info()"
                "print('\Информация о продвинутом автомобиле:')"
                "car2.display_info()",
            ...
            "изготовленные фирмой Bosh и создать из них новый список":
                ...
                "new_node.next = self.head"
                "def select_items_by_firm(self, firm_name):"
                "selected_items = []"
                "current = self.head"
                "if not self.head:"
                "return selected_items"
                "while True:"
                "if current.data['firm'] == firm_name:"
                "selected_items.append(current.data)"
                "current = current.next"
                ...
                "product_list = ["
                "{'name': 'Товар1', 'firm': 'Bosh'},"
                "{'name': 'Товар2', 'firm': 'Samsung'},"
                "{'name': 'Товар3', 'firm': 'Bosh'},"
                "{'name': 'Товар4', 'firm': 'LG'},"
                "{'name': 'Товар5', 'firm': 'Bosh'}"
                "]"
                "for product in product_list:"
                "products.append(product)"
                "print('Исходный список товаров:')"
                "products.display()"
                "bosh_products = products.select_items_by_firm('Bosh')"
                "print('\Товары фирмы Bosh:')"
                "for item in bosh_products:"
                "print(item)",
            ...
            "56. Дан двунаправленный связный список. Вставить элемент после n-гоэлемента списка.":
                ...
                "current.next = new_node"
                "else:"
                "print(f'Элемент с индексом {n} не найден')"
                "def display(self):"
                "elements = []"
                "current = self.head"
                "while current:"
                ...
                "dll.display()"
                "n = 2"
                "dll.insert_after_nth(n, 10)"
                "print(f'Список после вставки элемента после {n}-го элемента:')"
                "dll.display()",
            ...
            "57. Дан двунаправленный связный список. Удалить n-ый элемент списка.":
                ...
                "if current == self.head:"
                "self.head = current.next"
                "print(f'Элемент с индексом {n} удален')"
                "else:"
                "print(f'Элемент с индексом {n} не найден')"
                "def display(self):"
                "elements = []"
                ...
                "n = 2"
                "dll.delete_nth(n)"
                "print(f'Список после удаления {n}-го элемента:')"
                "dll.display()",
            ...
            "второй - каждый k-й.":
                ...
                "team1_names = ['Иванов', 'Петров', 'Сидоров', 'Кузнецов', 'Попов']"
                "team2_names = ['Смирнов', 'Ковалев', 'Орлов', 'Тарасов', 'Васильев']"
                ...
                "n = 2"
                "k = 3"
                "team1_selected = team1.select_nth(n)"
                "team2_selected = team2.select_nth(k)"
                "print(f'Игроки, выбранные из первой команды (каждый {n}-й):', team1_selected)"
                "print(f'Игроки, выбранные из второй команды (каждый {k}-й):', team2_selected)",
            ...
            "призов. Выиграет n человек (каждый k-й). Число для пересчета призов - t.":
                ...
                "break"
                "print('Список:', elements)"
                "def distribute_prizes(participants, prizes, n, k, t):"
                "winners = participants.select_nth(k, n)"
                "distributed_prizes = []"
                "prize_count = len(prizes.head.data)"
                "for i in range(n):"
                "prize_index = (i * t) % prize_count"
                "distributed_prizes.append((winners[i], prizes.head.data[prize_index]))"
                "prizes.head = prizes.head.next"
                "return distributed_prizes"
                "participants = CircularLinkedList()"
                "prizes = CircularLinkedList()"
                "participant_names = ['Иванов', 'Петров', 'Сидоров', 'Кузнецов', 'Попов', 'Смирнов', 'Ковалев']"
                "prize_names = ['Приз1', 'Приз2', 'Приз3', 'Приз4', 'Приз5']"
                ...
                "k = 2  "
                "t = 1  "
                "distributed_prizes = distribute_prizes(participants, prizes, n, k, t)"
                "print('Распределенные призы:')"
                "for winner, prize in distributed_prizes:"
                "print(f'Участник: {winner}, Приз: {prize}')",

            "62. Дан список с перечнем товаров. Выбрать все товары, изготовленные"
            "фирмой Bosh и создать из них новый список.":
                "class Product:"
                "def __init__(self, name, firm):"
                "self.name = name"
                "self.firm = firm"
                "def filter_bosh_products(products):"
                "return [product for product in products if product.firm == 'Bosh']"
                "products = ["
                "Product('Товар1', 'Bosh'),"
                "Product('Товар2', 'Samsung'),"
                "Product('Товар3', 'Bosh'),"
                "Product('Товар4', 'LG'),"
                "Product('Товар5', 'Bosh')"
                "]"
                "bosh_products = filter_bosh_products(products)"
                "print('Товары фирмы Bosh:')"
                "for product in bosh_products:"
                "print(f'Название: {product.name}, Фирма: {product.firm}')",
            ...
            "из 1-й группы во 2-ю. Число пересчета - k":
                ...
                "count = 0"
                "i = 0"
                "while len(selected_students) < n and i < len(group1):"
                "count += 1"
                "if count % k == 0:"
                "selected_students.append(group1[i])"
                "i += 1"
                ...
                "return group1, group2"
                "group1 = ['Иванов', 'Петров', 'Сидоров', 'Кузнецов', 'Попов', 'Смирнов', 'Ковалев']"
                "group2 = ['Тарасов', 'Васильев', 'Орлов', 'Лебедев', 'Егоров']"
                "n = 3"
                "k = 2 "
                "group1, group2 = transfer_students(group1, group2, n, k)"
                "print('Группа 1 после перевода:', group1)"
                "print('Группа 2 после перевода:', group2)",
            "65. Даны 2 списка: перечень товаров и фамилии покупателей. Каждый n-й"
            "покупатель покупает m-й товар. Вывести список покупок.":
                "def generate_purchases(products, buyers, n, m):"
                "purchases = []"
                "num_products = len(products)"
                "num_buyers = len(buyers)"
                "for i in range(0, num_buyers, n):"
                "buyer_index = i"
                "product_index = (i // n) * m % num_products"
                "if buyer_index < num_buyers:"
                "purchases.append((buyers[buyer_index], products[product_index]))"
                "return purchases"
                "products = ['Товар1', 'Товар2', 'Товар3', 'Товар4', 'Товар5']"
                "buyers = ['Иванов', 'Петров', 'Сидоров', 'Кузнецов', 'Попов', 'Смирнов', 'Ковалев']"
                "n = 2"
                "m = 3  "
                "purchases = generate_purchases(products, buyers, n, m)"
                "print('Список покупок:')"
                "for buyer, product in purchases:"
                "print(f'Покупатель: {buyer}, Товар: {product}')",
            ...
            "b) определяет число вхождений записи Е в дерево Т":
                ...
                "print(f'Самый левый лист: {E.data if E else 'None'}')"
                "occurrences = count_occurrences(root, E.data if E else None)"
                "print(f'Число вхождений {E.data if E else 'None'} в дерево: {occurrences}')",
