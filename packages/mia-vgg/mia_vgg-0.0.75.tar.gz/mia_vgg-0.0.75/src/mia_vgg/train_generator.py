...
if __name__=="__main__":
    ...
    os.makedirs(f"result/gan/{fold}", exist_ok=True)

    torch.save(netG.state_dict(), f"result/gan/{fold}/gan_weights")

    with open(f"result/gan/{fold}/G_losses.pickle", 'wb') as f:
        pickle.dump(G_losses, f)

    with open(f"result/gan/{fold}/D_losses.pickle", 'wb') as f:
