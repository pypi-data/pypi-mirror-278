...
class TestViewMode(unittest.TestCase):
    ...
    def test_to_proto_view_mode(self):
        self.assertEqual(ViewModeProto.VIEW_MODE_DEPLOYED, ViewMode.DEPLOYED._to_proto_view_mode())
        self.assertEqual(ViewModeProto.VIEW_MODE_EDIT, ViewMode.EDITOR._to_proto_view_mode())
        self.assertEqual(ViewModeProto.VIEW_MODE_PREVIEW, ViewMode.PREVIEW._to_proto_view_mode())
