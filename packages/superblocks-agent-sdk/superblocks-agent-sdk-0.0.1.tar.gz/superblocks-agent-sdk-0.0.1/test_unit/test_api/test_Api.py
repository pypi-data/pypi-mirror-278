...
from superblocks_agent.testing.step import Mock, Params
from superblocks_types.api.v1.event_pb2 import Event
from superblocks_types.api.v1.service_pb2 import ExecuteRequest, Function
from superblocks_types.api.v1.service_pb2 import Mock as ProtoMock
from superblocks_types.api.v1.service_pb2 import StreamResponse, TwoWayRequest, TwoWayResponse
        ...
        expected = ExecuteRequest(
            ...
            mocks=[
                Mock_(
                    ...
                    return_=ProtoMock.Return(static=to_protobuf_value({"some": "return"})),
                )
            ],
        )
