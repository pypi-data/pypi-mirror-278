...
conf = {
    bstack1ll1_opy_ (u"ࠩࡤࡴࡵࡥࡡࡶࡶࡲࡱࡦࡺࡥࠨ༚"): False,
    bstack1ll1_opy_ (u"ࠪࡦࡸࡺࡡࡤ࡭ࡢࡷࡪࡹࡳࡪࡱࡱࠫ༛"): True,
    bstack1ll1_opy_ (u"ࠫࡸࡱࡩࡱࡡࡶࡩࡸࡹࡩࡰࡰࡢࡷࡹࡧࡴࡶࡵࠪ༜"): False
}
class Config(object):
    instance = None
    def __init__(self):
        self._11l1l111ll_opy_ = conf
    @classmethod
    def bstack1lll11l1l1_opy_(cls):
        if cls.instance:
            return cls.instance
        return Config()
    def get_property(self, property_name):
        return self._11l1l111ll_opy_.get(property_name, None)
    def bstack1l1lll111l_opy_(self, property_name, bstack11l1l111l1_opy_):
        self._11l1l111ll_opy_[property_name] = bstack11l1l111l1_opy_
    def bstack111l111l_opy_(self, val):
        self._11l1l111ll_opy_[bstack1ll1_opy_ (u"ࠬࡹ࡫ࡪࡲࡢࡷࡪࡹࡳࡪࡱࡱࡣࡸࡺࡡࡵࡷࡶࠫ༝")] = bool(val)
    def bstack11ll1ll111_opy_(self):
        return self._11l1l111ll_opy_.get(bstack1ll1_opy_ (u"࠭ࡳ࡬࡫ࡳࡣࡸ࡫ࡳࡴ࡫ࡲࡲࡤࡹࡴࡢࡶࡸࡷࠬ༞"), False)