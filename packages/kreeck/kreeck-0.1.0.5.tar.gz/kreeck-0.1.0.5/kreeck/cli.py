...
def main():
    ...
    report_parser.add_argument('--email', type=str, help='Email to send the report to')
    ...
    if args.command == 'contribute':
        ...
        create_report(args.repo_path, args.email)
...
def show_info():
    ...
    report <repo_path> [--email EMAIL] Generate a detailed contributions report for the specified repository.
                                       Optionally send the report to the specified email.
    ...
    kreeck report https://github.com/yourusername/your-repo --email your_email@example.com
                                      Generate a detailed report for a GitHub repository and send it via email.
