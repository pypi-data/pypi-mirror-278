...
_columns_ = [
    ...
    _default_col_def | {
        ...
        "headerTooltip": "Interests, Taxes, Costs ... {ITC}"
    } | log_columns.Itc,
    _default_col_def | {
        "headerName": "Result",
        "children": [
    ...
    _default_col_def | {
        ...
        "headerTooltip": "y | m | d | H , M {HoldTime}"
    ...
    _default_col_def | {
        ...
        "children": [
            _default_col_def | {
                ...
                "headerTooltip": "Performance / (rounded 24h or 1) {Performance/Day}"
            ...
            _default_col_def | {
                ...
                "headerTooltip": "Profit / (rounded 24h or 1) {Profit/Day}"
