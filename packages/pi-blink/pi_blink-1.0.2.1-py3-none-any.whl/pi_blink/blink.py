...
class ListenerRegistry:
    ...
    def send_event(self, event: Any, sender: Any = None, ignore_errors: bool = False):
        """
        ...
        return sig.extended_send(event, ignore_errors=ignore_errors)

    async def asend_event(self, event: Any, sender: Any = None, ignore_errors: bool = False):
        """
        ...
        await sig.extended_send_async(event, ignore_errors=ignore_errors)
...
class Blink:
    ...
    @staticmethod
    def send(event: Any, sender: Any = None, ignore_errors: bool = False):
        """Send an event.
        Args:
            event (Any): The event to send.
            sender (Any): The sender of the event.
        """
        return _listener_registry.send_event(event, sender, ignore_errors=ignore_errors)

    @staticmethod
    def send_safe(event: Any, sender: Any = None):
        """Send an event, but ignore errors.
        Args:
            event (Any): The event to send.
            sender (Any): The sender of the event.
        """
        return _listener_registry.send_event(event, sender, ignore_errors=True)

    @staticmethod
    async def asend(event: Any, sender: Any = None, ignore_errors: bool = False):
        """Send an event asynchronously.
        Args:
            event (Any): The event to send.
            sender (Any): The sender of the event.
        """
        return await _listener_registry.asend_event(event, sender, ignore_errors=ignore_errors)

    @staticmethod
    async def asend_safe(event: Any, sender: Any = None):
        """Send an event asynchronously, but ignore errors.
        Args:
            event (Any): The event to send.
            sender (Any): The sender of the event.
        """
        return await _listener_registry.asend_event(event, sender, ignore_errors=True)
    ...
    @staticmethod
    def listener(signal_class, priority: EventPriority | None = None, sender: Any = ANY):
        """Register a listener.
        Args:
            signal_class (type): The signal class.
            sender (Any): The sender of the signal.
    ...
    @staticmethod
    def alistener(signal_class: Any, priority: EventPriority | None = None, sender: Any = ANY):
