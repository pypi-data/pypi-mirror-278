...
def _wrap_asgi_send(original_app_send, active_object, profiler_obj,
    ...
    async def _handler(*args, **kwargs):
        try:
            ...
            _log('exception', 'wrap_asgi_handler.send.pre', e)
            pass

        try:
            await original_app_send(*args, **kwargs)
        except Exception as e:
            _log('exception', 'wrap_asgi_handler.send.post', e)
...
def wrap_asgi_handler(original_app_func):
    async def _handler(*args, **kwargs):
        ...
        try:
            ...
            _log('exception', 'wrap_asgi_handler', e, tb)
        ...
        try:
            ...
            _log('exception', 'wrap_asgi_handler.post', e)
...
def asgi_get_wmonid(headers):
    ...
    if cookie_wmonid is not None:
        try:
            ...
            _log('exception', 'asgi_get_wmonid', cookie_wmonid, e)
            cookie_wmonid = None
