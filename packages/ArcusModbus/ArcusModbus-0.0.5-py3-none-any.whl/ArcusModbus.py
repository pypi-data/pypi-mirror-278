...
def DigInput_wait(probe: Probes, register, bit1: list):
    c = clist[int(probe.id)-1]
...
def Move(probe: Probes, distance): #give distance in mm
    ...
    InverseDigInput_wait(probe, 10, [4, 5, 6, 7, 20, 12, 21, 13, 28, 29, 30, 31]) #any combination of a 5 bit binary number with the third bit (4) on.
    builder.reset()
