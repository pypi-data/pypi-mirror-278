...
class Cli(object):
    ...
    def complement(self, config: str, pan_matrix: str = 'SG_test', verbose: str = 'INFO'):
        """ Based on syntelog and homolog, complement the genes marked as None in the temporary pan-sg
        :param config: <sample_name>    <fasta_path>    <gff3_path>
        :param pan_matrix: your syntelog-based pan-genome matrix before polishing
        :param verbose: CRITICAL, ERROR, WARNING, INFO, DEBUG, NOTSET
        :return:
        """
