...
class Client:
    ...
    def login(self, username, password=None, timeout=5):
        ...
        r = requests.post(url, headers=headers, data=json.dumps(data), verify=True, timeout=timeout, verify=self.verify)
    ...
    def message(self, cid: int, message: str, timeout: int=60) -> list:
        ...
        r = self.request("post", f'conversation/{cid}/message', data, verify=self.verify)
