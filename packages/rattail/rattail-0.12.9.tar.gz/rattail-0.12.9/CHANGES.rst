...
* feat: add config snippet for new projects, to define static libcache
* feat: add ``get_pkg_version()`` convenience function
* feat: define the ``app_package`` setting for new projects
