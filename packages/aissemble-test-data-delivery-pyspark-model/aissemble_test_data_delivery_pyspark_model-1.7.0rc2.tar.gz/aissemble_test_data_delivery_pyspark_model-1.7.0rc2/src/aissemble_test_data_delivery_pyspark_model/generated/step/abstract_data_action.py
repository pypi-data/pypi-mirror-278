...
class AbstractDataAction(ABC):
    ...
    def get_job_name(self) -> str:
        ...
        """
        return "PysparkDataDeliveryPatterns.{}".format(self.step_phase)
