...
class MessagingInboundAndOutboundAsyncBase(AbstractPipelineStep):
    ...
    def check_and_apply_encryption_policy(self, inbound: str) -> str:
        """
        ...
        MessagingInboundAndOutboundAsyncBase.logger.warn('Encryption is not yet supported for messaging without specifying an inbound record type!')
        MessagingInboundAndOutboundAsyncBase.logger.warn('If desired, please add encryption manually by overriding check_and_apply_encryption_policy()!')
        return inbound
    ...
    def apply_encryption_to_dataset(self, inbound: str, fields_to_update: List[str], algorithm: str) -> str:
        ...
        '''
        MessagingInboundAndOutboundAsyncBase.logger.info('applying encryption')
