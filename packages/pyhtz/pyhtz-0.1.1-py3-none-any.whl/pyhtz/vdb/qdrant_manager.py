...
import requests
from qdrant__client.models import Distance, VectorParams, UpsertOperation, PointsList, PointStruct 
from qdrant__client import Qdrant_client
from qdrant__client.http.exceptions import UnexpectedResponse, ResponseHandlingException
import pandas as pd
import retry
import time


class QdrantManager(Qdrant_client):
    METRIC_MAP = {
