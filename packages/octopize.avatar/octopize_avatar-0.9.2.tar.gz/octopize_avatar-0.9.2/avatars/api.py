...
class Pipelines:
    ...
    def avatarization_pipeline_with_processors(
        ...
        *,
        ...
        print(  # noqa: T201
            f"launching avatarization job with id={avatarization_job.id}"
        )
        ...
        print(f"launching privacy metrics job with id={privacy_job.id}")  # noqa: T201
        ...
        print(f"launching signal metrics job with id={signal_job.id}")  # noqa: T201
