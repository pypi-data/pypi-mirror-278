...
class CMakeBuild(build_ext):
    def run(self):
        ...
        for ext in self.extensions:
            ...
            dest_path = os.path.join(self.build_lib, 'mypylib', 'my_module', f'{ext.name}.so')
            src_path = os.path.join(self.build_temp, 'mypylib', 'my_module', f'{ext.name}.so')
...
setup(
    ...
    ext_modules=[Extension('libcallback_example', sources=[])],
    cmdclass={
