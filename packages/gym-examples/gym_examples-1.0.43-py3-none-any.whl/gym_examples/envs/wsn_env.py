...
class WSNRoutingEnv(gym.Env):
    ...
    def transmission_energy(self, i, distance):
        ...
        energy_consumption = self.number_of_packets[i] * info_amount * (Eelec + Eamp * distance**2)
        if energy_consumption < 0:
            print("=============================================")
            print("Energy consumption is negative!")
            ...
            print("Eelec: ", Eelec)
            print("Eamp: ", Eamp)
            print(f"sensor_positions[{i}]: ", self.sensor_positions[i])            
            print("=============================================")

            raise Exception("Energy consumption is negative!")
    ...
    def reception_energy(self, i):
        ...
        energy_reception = self.number_of_packets[i] * info_amount * Eelec
        if energy_reception < 0:
            print("=============================================")
            print("Energy consumption is negative!")
            print("Here are the parameters:")
            print("i: ", i)
            ...
            print("info_amount: ", info_amount)
            print("Eelec: ", Eelec)
            print("sensor_positions: ", self.sensor_positions[i])
            print("=============================================")
            

            raise Exception("Energy reception is negative!")
