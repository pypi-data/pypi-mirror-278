...
def FsSpreadsheet_FsWorkbook__FsWorkbook_fromJsonString_Static_Z721C83C5(json: str) -> FsWorkbook:
    return Json.from_json_string(json)


def FsSpreadsheet_FsWorkbook__FsWorkbook_toJsonString_Static_32154C9D(wb: FsWorkbook) -> str:
    return Json.to_json_string(wb)


def FsSpreadsheet_FsWorkbook__FsWorkbook_ToJsonString(this: FsWorkbook) -> str:
    return FsSpreadsheet_FsWorkbook__FsWorkbook_toJsonString_Static_32154C9D(this)


__all__ = ["FsSpreadsheet_FsWorkbook__FsWorkbook_fromXlsxFile_Static_Z721C83C5", "FsSpreadsheet_FsWorkbook__FsWorkbook_fromXlsxStream_Static_4D976C1A", "FsSpreadsheet_FsWorkbook__FsWorkbook_fromXlsxBytes_Static_Z3F6BC7B1", "FsSpreadsheet_FsWorkbook__FsWorkbook_toXlsxFile_Static", "FsSpreadsheet_FsWorkbook__FsWorkbook_toXlsxBytes_Static_32154C9D", "FsSpreadsheet_FsWorkbook__FsWorkbook_ToXlsxFile_Z721C83C5", "FsSpreadsheet_FsWorkbook__FsWorkbook_ToXlsxBytes", "FsSpreadsheet_FsWorkbook__FsWorkbook_fromJsonString_Static_Z721C83C5", "FsSpreadsheet_FsWorkbook__FsWorkbook_toJsonString_Static_32154C9D", "FsSpreadsheet_FsWorkbook__FsWorkbook_ToJsonString"]
