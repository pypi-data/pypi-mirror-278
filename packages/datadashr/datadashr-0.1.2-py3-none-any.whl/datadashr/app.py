...
class App:
    ...
    def initialize_app(self):
        if not self.verify_if_ollama_server_is_running() or not self.check_ollama_list():
            logger.error("Ollama server non è disponibile. Verifica l'installazione.")
            exit()
    ...
    def setup_ui(self):
        ...
        self.box_switch = pn.WidgetBox('# Settings', self.cache_label, self.cache_switch, self.verbose_label,
                                       self.verbose_switch, self.vector_label, self.vector_switch, width=350, styles={'margin-bottom': '10px'})
    ...
    def update_datadashr(self, event=None):
        ...
        try:
            ...
            try:
                ...
                logger.error("Errore nella decodifica del file CSV. Prova a caricare un file con un diverso encoding.")
    ...
    def serve(self):
        ...
        dashboard = pn.Column(
            pn.pane.SVG("https://www.datadashr.com/wp-content/uploads/2024/06/datadashr.svg", height=30),
