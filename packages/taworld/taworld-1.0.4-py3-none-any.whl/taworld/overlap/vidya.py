...
from taworld.utils import get_drift, get_offset, verify_series
...
def vidya(close, length=None, drift=None, offset=None, **kwargs):
    ...
    def _cmo(source: Series, n:int , d: int):
        ...
        For some reason: from taworld.momentum import cmo causes
        taworld.momentum.coppock to not be able to import it's
        wma like from taworld.overlap import wma?
