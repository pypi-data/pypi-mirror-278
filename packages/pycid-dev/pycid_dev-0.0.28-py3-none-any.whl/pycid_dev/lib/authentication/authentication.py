...
class Auth0Authentication(AuthenticationInterface):
    def __init__(
        self, auth_path: str = "./auth.json", auth_file_lock_path: str = "./auth.lock"
    ):
        self._auth_path = auth_path
        self._auth_file_lock_path = auth_file_lock_path
    ...
    def refresh(self):
        ...
        def refresh_access_token():
            ...
            token_url = "https://dev-lcts343d1y6dwzvc.us.auth0.com/oauth/token"
            ...
            try:
                ...
                conn = http.client.HTTPSConnection("dev-lcts343d1y6dwzvc.us.auth0.com")
