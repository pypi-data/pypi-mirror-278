'''bffl.expressions: Support for high-performance expression processing

The core bffl model is based on python's unbound integers, so by design there
...
Although bffl has no third party requirements, the features supported by
