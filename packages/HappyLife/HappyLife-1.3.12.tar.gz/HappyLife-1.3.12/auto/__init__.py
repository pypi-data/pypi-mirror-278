...
class Bd:
    ...
    def mouse_drag(self,x,y,x2,y2,delay=1):
        '''
        ...
        win32api.SendMessage(self.hwnd, win32con.WM_LBUTTONDOWN, 1, ((int(self.y/self.display_zoom)) << 16 | (int(self.x//self.display_zoom))))
        time.sleep(delay)
        win32api.PostMessage(self.hwnd, win32con.WM_MOUSEMOVE, 1, (int(self.y/self.display_zoom) << 16 | int(self.x//self.display_zoom)))
