...
_release_version: str = '0.4.29'

# The following line is overwritten by build scripts in distributions &
# releases. Do not modify this manually, or jax/jaxlib build will fail.
_git_hash: str = '991797a8a987f241074ccd2a94ad2aaec684537c'
...
def _write_version(fname: str) -> None:
  ...
  old_version_string = "_release_version: str = '0.4.29'"
  ...
  if githash:
    old_githash_string = "_git_hash: str = '991797a8a987f241074ccd2a94ad2aaec684537c'"
