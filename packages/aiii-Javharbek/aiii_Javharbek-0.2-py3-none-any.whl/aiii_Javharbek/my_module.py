...
def procceced_image2(image, polygon_cords, is_show=False, width=1024, height=1448):
    ...
    result_image = resize_with_padding(procceced_image_clean_data_image, 2048, 2048)
    resize_with_padding_data_1 = resize_with_padding_data(procceced_image_clean_data_image, 2048, 2048)
