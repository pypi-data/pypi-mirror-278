...
class Post(models.Model):
    ...
    category = models.ForeignKey(PostCategory, related_name='post_category', on_delete=models.PROTECT)
    ...
    def get_absolute_url(self):
        ...
        return reverse(postds.context['template_name'] + ':post_detail', kwargs={"slug": str(self.slug)})
