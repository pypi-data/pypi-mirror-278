...
try:
     ...
     from textchat.chat.screens.quit import QuitScreen
try:
    from .screens.settings import SettingsScreen
except:
     from textchat.chat.screens.settings import SettingsScreen
...
from textual.widgets import Input, Label, TabbedContent, TabPane,Tree
from textual.worker import get_current_worker
try:
    from .client import IRCApp
except:
    from textchat.chat.client import IRCApp
try:
    from .screens.irc import IRCScreen
except:
    from textchat.chat.screens.irc import IRCScreen
try: 
     from .screens.settings import SettingsScreen
except:
     from textchat.chat.screens.settings import SettingsScreen
