...
from civis_jupyter_ext.magics.query import magic


@pytest.mark.parametrize("rows", [[("a", 1), ("b", 2)], []])
...
@pytest.mark.parametrize(
    "sep,database", [(" ", '"My Database"'), (" ", "my-database"), (" ", "123")]
)
@pytest.mark.parametrize("cols", [(["a", "b"], [1, 2]), ([], [])])
@mock.patch("civis_jupyter_ext.magics.query.civis")
