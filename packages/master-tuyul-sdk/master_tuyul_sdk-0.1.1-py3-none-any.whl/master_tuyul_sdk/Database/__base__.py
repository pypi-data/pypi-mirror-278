...
class Database:
    ...
    class Build:
        ...
        def __init__(self) -> None:
            ...
            elif self.Type == TypeDatabase.MEMORI or self.Type == TypeDatabase.OFFLINE:
                if self.FileName is not None and self.PathName is not None and self.Type == TypeDatabase.MEMORI:
