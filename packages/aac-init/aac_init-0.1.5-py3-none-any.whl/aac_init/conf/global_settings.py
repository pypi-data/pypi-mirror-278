...
OUTPUT_BASE_DIR = os.path.join(os.getcwd(), "aac_init_output_working_dir")
...
TEMPLATE_DIR = [
    [os.path.join(BASE_DIR, "templates", "01-wipe_aci_fabric", "apic"),
    os.path.join(BASE_DIR, "templates", "01-wipe_aci_fabric", "aci_switch")],
...
YAML_NAME = [
    ['playbook_aci_switch_init.yaml', 'playbook_apic_init.yaml'],
