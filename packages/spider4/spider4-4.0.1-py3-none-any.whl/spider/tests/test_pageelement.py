"""Tests of the spider.element.PageElement class"""
import copy
import pickle
import pytest
import sys
...
"""
        encoded = Spider(doc, 'html.parser').encode()
...
"""
    ...
    def test_prettify_accepts_formatter_function(self):
        soup = Spider("<html><body>foo</body></html>", 'html.parser')
    ...
    def test_encoding_substitution_doesnt_happen_if_tag_is_strained(self):
        ...
        # Spider used to try to rewrite the meta tag even if the
...
<title>Spider: We called him Tortoise because he taught us.</title>
<link rev="made" href="mailto:leonardr@segfault.org">
<meta name="Description" content="Spider: an HTML parser optimized for screen-scraping.">
