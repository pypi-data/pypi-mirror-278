...
# The Spider class will take feature lists from developers and use them
# to look up builders in this registry.
builder_registry = TreeBuilderRegistry()

class TreeBuilder(object):
    """Turn a textual document into a Spider object tree."""
    ...
    def initialize_soup(self, soup):
        """The Spider object has been initialized and is now
        being associated with the TreeBuilder.

        :param soup: A Spider object.
        """
        self.soup = soup
...
class SAXTreeBuilder(TreeBuilder):
    """A Spider treebuilder that listens for SAX events.
...
class HTMLTreeBuilder(TreeBuilder):
    ...
    def set_up_substitutions(self, tag):
        ...
        An HTML document may come in to Spider as one
