...
from spider.builder._htmlparser import SpiderHTMLParser
...
class TestHTMLParserTreeBuilder(SoupTest, HTMLTreeBuilderSmokeTest):
    ...
    def test_rejected_input(self):
        ...
        # different ways, but Spider consistently raises
    ...
    def test_on_duplicate_attribute(self):
        ...
        assert_attribute(SpiderHTMLParser.REPLACE, "url3")

        # You can ignore subsequent values in favor of the first.
        assert_attribute(SpiderHTMLParser.IGNORE, "url1")
