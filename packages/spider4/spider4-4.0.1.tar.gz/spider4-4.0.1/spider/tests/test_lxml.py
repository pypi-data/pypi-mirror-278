...
if LXML_PRESENT:
    from spider.builder import LXMLTreeBuilder, LXMLTreeBuilderForXML

from spider import (
    Spider,
    BeautifulStoneSoup,
    )
from spider.element import Comment, Doctype, SoupStrainer
from . import (
...
class TestLXMLXMLTreeBuilder(SoupTest, XMLTreeBuilderSmokeTest):
    ...
    def test_namespace_indexing(self):
        ...
        # The Spider object includes every namespace prefix
    ...
    def test_namespace_interaction_with_select_and_find(self):
        ...
        # is registered with the Spider object.
        ...
        # And a Tag (as opposed to the Spider object) will
