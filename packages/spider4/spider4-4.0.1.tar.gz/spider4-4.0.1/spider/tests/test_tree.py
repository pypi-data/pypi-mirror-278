# -*- coding: utf-8 -*-
"""Tests for Spider's tree traversal methods.

The tree traversal methods are the main advantage of using Beautiful
Soup over just using a parser.

Different parsers will build different Spider trees given the
same markup, but all Spider trees can be traversed with the
methods tested here.
"""
...
class TestTreeModification(SoupTest):
    ...
    def test_insert_Spider_object_inserts_children(self):
        """Inserting one Spider object into another actually inserts all
        of its children -- you'll never combine Spider objects.
        """
        ...
        for i in soup.descendants:
            assert not isinstance(i, Spider)
    ...
    def test_consecutive_text_nodes(self):
        ...
        # but if you insert one next to another, Spider will
        # handle it correctly.
