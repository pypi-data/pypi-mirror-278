...
class SoupTest(object):
    ...
    def soup(self, markup, **kwargs):
        """Build a Spider object from markup."""
        builder = kwargs.pop('builder', self.default_builder)
        return Spider(markup, builder=builder, **kwargs)
    ...
    def assert_soup(self, to_parse, compare_parsed_to=None):
        """Parse some markup using Spider and verify that
        the output markup is as expected.
        """
        builder = self.default_builder
        obj = Spider(to_parse, builder=builder)
        ...
        # Also run some checks on the Spider object itself:
...
class HTMLTreeBuilderSmokeTest(TreeBuilderSmokeTest):
    ...
    def test_pickle_and_unpickle_identity(self):
        ...
        assert loaded.__class__ == Spider
...
<body>Goodbye.</body>
    ...
    def test_deepcopy(self):
        ...
        Spider object, and we want to be able to copy that.
        """
...
"""
    ...
    # Spider than tests of the tree builders. But parsers are
    ...
    def test_closing_tag_with_no_opening_tag(self):
        # Without Spider.open_tag_counter, the </span> tag will
