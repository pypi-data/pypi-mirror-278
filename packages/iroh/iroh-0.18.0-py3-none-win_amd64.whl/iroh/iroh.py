...
def _uniffi_check_api_checksums(lib):
    ...
    if lib.uniffi_iroh_checksum_method_authorid_to_string() != 42389:
        raise InternalError("UniFFI API checksum mismatch: try cleaning and rebuilding your project")
    if lib.uniffi_iroh_checksum_method_blobticket_as_download_options() != 57522:
        raise InternalError("UniFFI API checksum mismatch: try cleaning and rebuilding your project")
    ...
    if lib.uniffi_iroh_checksum_method_entry_namespace() != 52248:
        raise InternalError("UniFFI API checksum mismatch: try cleaning and rebuilding your project")
    if lib.uniffi_iroh_checksum_method_entry_timestamp() != 20078:
        raise InternalError("UniFFI API checksum mismatch: try cleaning and rebuilding your project")
    ...
    if lib.uniffi_iroh_checksum_method_irohnode_author_create() != 31148:
        raise InternalError("UniFFI API checksum mismatch: try cleaning and rebuilding your project")
    if lib.uniffi_iroh_checksum_method_irohnode_author_default() != 47205:
        raise InternalError("UniFFI API checksum mismatch: try cleaning and rebuilding your project")
    ...
    if lib.uniffi_iroh_checksum_method_irohnode_blobs_delete_blob() != 24766:
        raise InternalError("UniFFI API checksum mismatch: try cleaning and rebuilding your project")
    if lib.uniffi_iroh_checksum_method_irohnode_blobs_download() != 41238:
        raise InternalError("UniFFI API checksum mismatch: try cleaning and rebuilding your project")
    ...
    if lib.uniffi_iroh_checksum_method_irohnode_blobs_list() != 49039:
        raise InternalError("UniFFI API checksum mismatch: try cleaning and rebuilding your project")
    if lib.uniffi_iroh_checksum_method_irohnode_blobs_list_collections() != 28291:
        raise InternalError("UniFFI API checksum mismatch: try cleaning and rebuilding your project")
    if lib.uniffi_iroh_checksum_method_irohnode_blobs_list_incomplete() != 13645:
        raise InternalError("UniFFI API checksum mismatch: try cleaning and rebuilding your project")
    ...
    if lib.uniffi_iroh_checksum_method_irohnode_doc_join() != 48292:
        raise InternalError("UniFFI API checksum mismatch: try cleaning and rebuilding your project")
    if lib.uniffi_iroh_checksum_method_irohnode_doc_join_and_subscribe() != 43177:
        raise InternalError("UniFFI API checksum mismatch: try cleaning and rebuilding your project")
    ...
    if lib.uniffi_iroh_checksum_method_irohnode_stats() != 16158:
        raise InternalError("UniFFI API checksum mismatch: try cleaning and rebuilding your project")
    if lib.uniffi_iroh_checksum_method_irohnode_status() != 9322:
        raise InternalError("UniFFI API checksum mismatch: try cleaning and rebuilding your project")
    if lib.uniffi_iroh_checksum_method_irohnode_tags_delete() != 19876:
        raise InternalError("UniFFI API checksum mismatch: try cleaning and rebuilding your project")
    if lib.uniffi_iroh_checksum_method_irohnode_tags_list() != 4609:
        raise InternalError("UniFFI API checksum mismatch: try cleaning and rebuilding your project")
    ...
    if lib.uniffi_iroh_checksum_method_nodeaddr_relay_url() != 52692:
        raise InternalError("UniFFI API checksum mismatch: try cleaning and rebuilding your project")
    if lib.uniffi_iroh_checksum_method_nodestatus_listen_addrs() != 5306:
        raise InternalError("UniFFI API checksum mismatch: try cleaning and rebuilding your project")
    if lib.uniffi_iroh_checksum_method_nodestatus_node_addr() != 53928:
        raise InternalError("UniFFI API checksum mismatch: try cleaning and rebuilding your project")
    if lib.uniffi_iroh_checksum_method_nodestatus_version() != 46131:
        raise InternalError("UniFFI API checksum mismatch: try cleaning and rebuilding your project")
    ...
    if lib.uniffi_iroh_checksum_constructor_authorid_from_string() != 14210:
        raise InternalError("UniFFI API checksum mismatch: try cleaning and rebuilding your project")
    if lib.uniffi_iroh_checksum_constructor_blobdownloadoptions_new() != 30799:
        raise InternalError("UniFFI API checksum mismatch: try cleaning and rebuilding your project")
    ...
    if lib.uniffi_iroh_checksum_constructor_query_single_latest_per_key() != 42778:
        raise InternalError("UniFFI API checksum mismatch: try cleaning and rebuilding your project")
    if lib.uniffi_iroh_checksum_constructor_query_single_latest_per_key_exact() != 1670:
        raise InternalError("UniFFI API checksum mismatch: try cleaning and rebuilding your project")
    if lib.uniffi_iroh_checksum_constructor_query_single_latest_per_key_prefix() != 21174:
        raise InternalError("UniFFI API checksum mismatch: try cleaning and rebuilding your project")
...
_UniffiLib.uniffi_iroh_fn_free_blobdownloadoptions.argtypes = (
    ctypes.c_void_p,
    ctypes.POINTER(_UniffiRustCallStatus),
)
_UniffiLib.uniffi_iroh_fn_free_blobdownloadoptions.restype = None
_UniffiLib.uniffi_iroh_fn_constructor_blobdownloadoptions_new.argtypes = (
    _UniffiRustBuffer,
    ctypes.c_void_p,
    ctypes.c_void_p,
    ctypes.POINTER(_UniffiRustCallStatus),
)
_UniffiLib.uniffi_iroh_fn_constructor_blobdownloadoptions_new.restype = ctypes.c_void_p
...
_UniffiLib.uniffi_iroh_fn_method_blobticket_as_download_options.argtypes = (
    ctypes.c_void_p,
    ctypes.POINTER(_UniffiRustCallStatus),
)
_UniffiLib.uniffi_iroh_fn_method_blobticket_as_download_options.restype = ctypes.c_void_p
...
_UniffiLib.uniffi_iroh_fn_method_entry_timestamp.argtypes = (
    ctypes.c_void_p,
    ctypes.POINTER(_UniffiRustCallStatus),
)
_UniffiLib.uniffi_iroh_fn_method_entry_timestamp.restype = ctypes.c_uint64
...
_UniffiLib.uniffi_iroh_fn_method_irohnode_author_default.argtypes = (
    ctypes.c_void_p,
    ctypes.POINTER(_UniffiRustCallStatus),
)
_UniffiLib.uniffi_iroh_fn_method_irohnode_author_default.restype = ctypes.c_void_p
...
_UniffiLib.uniffi_iroh_fn_method_irohnode_doc_join_and_subscribe.argtypes = (
    ctypes.c_void_p,
    _UniffiRustBuffer,
    ctypes.c_uint64,
    ctypes.POINTER(_UniffiRustCallStatus),
)
_UniffiLib.uniffi_iroh_fn_method_irohnode_doc_join_and_subscribe.restype = ctypes.c_void_p
...
_UniffiLib.uniffi_iroh_fn_free_nodestatus.argtypes = (
    ctypes.c_void_p,
    ctypes.POINTER(_UniffiRustCallStatus),
)
_UniffiLib.uniffi_iroh_fn_free_nodestatus.restype = None
_UniffiLib.uniffi_iroh_fn_method_nodestatus_listen_addrs.argtypes = (
    ctypes.c_void_p,
    ctypes.POINTER(_UniffiRustCallStatus),
)
_UniffiLib.uniffi_iroh_fn_method_nodestatus_listen_addrs.restype = _UniffiRustBuffer
_UniffiLib.uniffi_iroh_fn_method_nodestatus_node_addr.argtypes = (
    ctypes.c_void_p,
    ctypes.POINTER(_UniffiRustCallStatus),
)
_UniffiLib.uniffi_iroh_fn_method_nodestatus_node_addr.restype = ctypes.c_void_p
_UniffiLib.uniffi_iroh_fn_method_nodestatus_version.argtypes = (
    ctypes.c_void_p,
    ctypes.POINTER(_UniffiRustCallStatus),
)
_UniffiLib.uniffi_iroh_fn_method_nodestatus_version.restype = _UniffiRustBuffer
...
_UniffiLib.uniffi_iroh_fn_constructor_query_single_latest_per_key_exact.argtypes = (
    _UniffiRustBuffer,
    ctypes.POINTER(_UniffiRustCallStatus),
)
_UniffiLib.uniffi_iroh_fn_constructor_query_single_latest_per_key_exact.restype = ctypes.c_void_p
_UniffiLib.uniffi_iroh_fn_constructor_query_single_latest_per_key_prefix.argtypes = (
    _UniffiRustBuffer,
    _UniffiRustBuffer,
    ctypes.POINTER(_UniffiRustCallStatus),
)
_UniffiLib.uniffi_iroh_fn_constructor_query_single_latest_per_key_prefix.restype = ctypes.c_void_p
...
_UniffiLib.uniffi_iroh_checksum_method_blobticket_as_download_options.argtypes = (
)
_UniffiLib.uniffi_iroh_checksum_method_blobticket_as_download_options.restype = ctypes.c_uint16
...
_UniffiLib.uniffi_iroh_checksum_method_entry_timestamp.argtypes = (
)
_UniffiLib.uniffi_iroh_checksum_method_entry_timestamp.restype = ctypes.c_uint16
...
_UniffiLib.uniffi_iroh_checksum_method_irohnode_author_default.argtypes = (
)
_UniffiLib.uniffi_iroh_checksum_method_irohnode_author_default.restype = ctypes.c_uint16
...
_UniffiLib.uniffi_iroh_checksum_method_irohnode_doc_join_and_subscribe.argtypes = (
)
_UniffiLib.uniffi_iroh_checksum_method_irohnode_doc_join_and_subscribe.restype = ctypes.c_uint16
...
_UniffiLib.uniffi_iroh_checksum_method_nodestatus_listen_addrs.argtypes = (
)
_UniffiLib.uniffi_iroh_checksum_method_nodestatus_listen_addrs.restype = ctypes.c_uint16
_UniffiLib.uniffi_iroh_checksum_method_nodestatus_node_addr.argtypes = (
)
_UniffiLib.uniffi_iroh_checksum_method_nodestatus_node_addr.restype = ctypes.c_uint16
_UniffiLib.uniffi_iroh_checksum_method_nodestatus_version.argtypes = (
)
_UniffiLib.uniffi_iroh_checksum_method_nodestatus_version.restype = ctypes.c_uint16
...
_UniffiLib.uniffi_iroh_checksum_constructor_blobdownloadoptions_new.argtypes = (
)
_UniffiLib.uniffi_iroh_checksum_constructor_blobdownloadoptions_new.restype = ctypes.c_uint16
...
_UniffiLib.uniffi_iroh_checksum_constructor_query_single_latest_per_key_exact.argtypes = (
)
_UniffiLib.uniffi_iroh_checksum_constructor_query_single_latest_per_key_exact.restype = ctypes.c_uint16
_UniffiLib.uniffi_iroh_checksum_constructor_query_single_latest_per_key_prefix.argtypes = (
)
_UniffiLib.uniffi_iroh_checksum_constructor_query_single_latest_per_key_prefix.restype = ctypes.c_uint16
...
class BlobDownloadOptions:
    ...
    def __init__(self, format: "BlobFormat",node: "NodeAddr",tag: "SetTagOption"):
        ...
        self._pointer = _rust_call_with_error(_UniffiConverterTypeIrohError,_UniffiLib.uniffi_iroh_fn_constructor_blobdownloadoptions_new,
    ...
    def __del__(self):
        ...
        pointer = getattr(self, "_pointer", None)
        if pointer is not None:
            _rust_call(_UniffiLib.uniffi_iroh_fn_free_blobdownloadoptions, pointer)
...
class BlobTicket:
    ...
    def as_download_options(self, ) -> "BlobDownloadOptions":
        ...
        return _UniffiConverterTypeBlobDownloadOptions.lift(
            _rust_call(_UniffiLib.uniffi_iroh_fn_method_blobticket_as_download_options,self._pointer,)
        )
...
class Entry:
    ...
    def timestamp(self, ) -> "int":
        ...
        return _UniffiConverterUInt64.lift(
            _rust_call(_UniffiLib.uniffi_iroh_fn_method_entry_timestamp,self._pointer,)
        )
...
class IrohNode:
    ...
    def author_default(self, ) -> "AuthorId":
        '''
        ...
        return _UniffiConverterTypeAuthorId.lift(
            _rust_call_with_error(
    _UniffiConverterTypeIrohError,_UniffiLib.uniffi_iroh_fn_method_irohnode_author_default,self._pointer,)
        )
    ...
    def blobs_download(self, hash: "Hash",req: "BlobDownloadOptions",cb: "DownloadCallback"):
    ...
    _UniffiConverterTypeIrohError,_UniffiLib.uniffi_iroh_fn_method_irohnode_blobs_download,self._pointer,
        _UniffiConverterTypeHash.lower(hash),
        _UniffiConverterTypeBlobDownloadOptions.lower(req),
    ...
    def blobs_list_collections(self, ) -> "typing.List[CollectionInfo]":
        '''
        ...
        Please file an [issue](https://github.com/n0-computer/iroh-ffi/issues/new) if you run into this issue
        '''
        return _UniffiConverterSequenceTypeCollectionInfo.lift(
            _rust_call_with_error(
    ...
    def blobs_list_incomplete(self, ) -> "typing.List[IncompleteBlobInfo]":
        '''
        ...
        Please file an [issue](https://github.com/n0-computer/iroh-ffi/issues/new) if you run into this issue
        '''
        return _UniffiConverterSequenceTypeIncompleteBlobInfo.lift(
            _rust_call_with_error(
    ...
    def doc_join_and_subscribe(self, ticket: "str",cb: "SubscribeCallback") -> "Doc":
        '''Join and sync with an already existing document and subscribe to events on that document.'''
        
        
        return _UniffiConverterTypeDoc.lift(
            _rust_call_with_error(
    _UniffiConverterTypeIrohError,_UniffiLib.uniffi_iroh_fn_method_irohnode_doc_join_and_subscribe,self._pointer,
        _UniffiConverterString.lower(ticket),
        _UniffiConverterCallbackInterfaceSubscribeCallback.lower(cb))
        )
    ...
    def tags_list(self, ) -> "typing.List[TagInfo]":
        '''
        List all tags
        ...
        Please file an [issue](https://github.com/n0-computer/iroh-ffi/issues/new) if you run into this issue
        '''
        return _UniffiConverterSequenceTypeTagInfo.lift(
            _rust_call_with_error(
...
class NodeStatus:
    ...
    def __del__(self):
        ...
        pointer = getattr(self, "_pointer", None)
        if pointer is not None:
            _rust_call(_UniffiLib.uniffi_iroh_fn_free_nodestatus, pointer)
    ...
    def listen_addrs(self, ) -> "typing.List[str]":
        ...
        return _UniffiConverterSequenceString.lift(
            _rust_call(_UniffiLib.uniffi_iroh_fn_method_nodestatus_listen_addrs,self._pointer,)
        )
    ...
    def node_addr(self, ) -> "NodeAddr":
        ...
        return _UniffiConverterTypeNodeAddr.lift(
            _rust_call(_UniffiLib.uniffi_iroh_fn_method_nodestatus_node_addr,self._pointer,)
        )
    ...
    def version(self, ) -> "str":
        ...
        return _UniffiConverterString.lift(
            _rust_call(_UniffiLib.uniffi_iroh_fn_method_nodestatus_version,self._pointer,)
        )
...
class Query:
    ...
    @classmethod
    def single_latest_per_key_exact(cls, exact: "bytes"):
        '''
        ...
        # Call the (fallible) function before creating any half-baked object instances.
        pointer = _rust_call(_UniffiLib.uniffi_iroh_fn_constructor_query_single_latest_per_key_exact,
        _UniffiConverterBytes.lower(exact))
        return cls._make_instance_(pointer)
    ...
    def single_latest_per_key_prefix(cls, prefix: "bytes",opts: "typing.Optional[QueryOptions]"):
        ...
        # Call the (fallible) function before creating any half-baked object instances.
        pointer = _rust_call(_UniffiLib.uniffi_iroh_fn_constructor_query_single_latest_per_key_prefix,
        _UniffiConverterBytes.lower(prefix),
        _UniffiConverterOptionalTypeQueryOptions.lower(opts))
        return cls._make_instance_(pointer)
