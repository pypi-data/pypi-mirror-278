...
def main(args=None):
    ...
    train_parser.add_argument("--metric", type=str, help="metric name. i.e. accuracy", required=True)
    train_parser.add_argument("--threshold", type=str, help="threshold. i.e. 0.8", required=True)
