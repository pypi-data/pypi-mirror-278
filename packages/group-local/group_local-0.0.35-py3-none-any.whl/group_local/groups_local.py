...
class GroupsLocal(GenericCRUDML, metaclass=MetaLogger,
    ...
    def insert(  # noqa
        ...
        group_data_dict = {
            ...
            "main_group_type_id": group_dict.get('main_group_type_id', None),
    ...
    def __insert_link_job_title(self, group_dict: dict, group_id: int) -> dict:
        self.logger.start("start insert_link_job_title", object={"group_dict": group_dict})
        # Insert job title
        job_title_dict = {
            "name": group_dict.get('name'),
            "title": group_dict.get('title'),
        ...
        if insert_job_result:
            ...
            self.logger.info(log_message="job_title inserted",
        ...
        self.logger.end("end insert_link_job_title", object=result_dict)
        return result_dict
