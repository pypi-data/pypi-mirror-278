...
class GigaChatEntryPoint:
    def __init__(self, client_id, client_secret):
        self.creds = b64encode(f'{client_id}:{client_secret}'.encode('utf-8')).decode('utf-8')
        self.model = GigaChat(
    ...
    def get_embeddings(self, sentences: t.List[str], request_limit=10) -> t.List[t.List]:
        embeddings = None
        counter = 0
    ...
    def get_more_embeddings(
        ...
        emb_batches = list(chain.from_iterable([
