...
def write_readme(ctx):
    ...
    do_not_edit = """
..
    This file has been generated by ``inv bd` from the docstring of the
    :file:`setup.py` file. Do not edit this file, but edit the :file:`setup.py` file
    and run ``doctest setup.py`` before generating it again.

"""
    do_not_edit = "\n"  # good idea, but lets do it later
...
def pepper(ctx):
    ...
    # NB The ""-e '*/help_texts.py'" can be removed soon because newly generated help_texts.py files now contain "# yapf: disable"
...
def pull(ctx, batch=False):
    """
    Pull latest changes, including those from upstream there is one.
