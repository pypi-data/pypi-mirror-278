...
def create_grm_matrix(dosage_matrix: DosageMatrix):
    """
    Reads a dosage matrix and create a GRM matrix by converting all values > 0
    ...
    Returns:
        GRM dataframe: A dataframe where all values > 0 are converted
