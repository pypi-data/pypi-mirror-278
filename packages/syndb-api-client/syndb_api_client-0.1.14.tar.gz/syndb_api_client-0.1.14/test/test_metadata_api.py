...
class TestMetadataApi(unittest.TestCase):
    ...
    def test_get_modifiable_datasets_neurodata_metadata_dataset_get_modifiable_get(self) -> None:
        """Test case for get_modifiable_datasets_neurodata_metadata_dataset_get_modifiable_get
