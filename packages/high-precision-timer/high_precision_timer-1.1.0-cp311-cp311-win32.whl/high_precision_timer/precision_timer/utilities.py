...
def convert_time(
    ...
    Raises:
        TypeError: If 'time' argument is not of a valid type or any of the elements of the time list / numpy array
            are not float-convertible.
    ...
    # Verifies that the input time uses a valid type. There are additional checks for list and numpy array inputs below.
    ...
    # Converts the time to the desired time format. Rounds the resultant values to 3 decimal points. If the input was
...
def get_timestamp(time_separator: str = "-") -> str:
    """Obtains the current date and time (to seconds) and formats it into year-month-day-hour-minute-second string.
