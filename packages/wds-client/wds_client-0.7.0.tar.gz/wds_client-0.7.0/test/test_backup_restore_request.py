...
import wds_client
from wds_client.models.backup_restore_request import BackupRestoreRequest  # noqa: E501
...
class TestBackupRestoreRequest(unittest.TestCase):
    ...
    def make_instance(self, include_optional):
        ...
        # model = wds_client.models.backup_restore_request.BackupRestoreRequest()  # noqa: E501
        if include_optional :
            return BackupRestoreRequest(
                requesting_workspace_id = '0', 
                description = '0'
            )
        else :
            return BackupRestoreRequest(
