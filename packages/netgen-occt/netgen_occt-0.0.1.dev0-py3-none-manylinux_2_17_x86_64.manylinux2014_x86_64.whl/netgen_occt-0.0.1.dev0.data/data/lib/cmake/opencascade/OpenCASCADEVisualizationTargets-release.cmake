...
set_target_properties(TKService PROPERTIES
  IMPORTED_LOCATION_RELEASE "${_IMPORT_PREFIX}/./libTKService.so.7.8.2"
  IMPORTED_SONAME_RELEASE "libTKService.so.7.8.2"
  )

list(APPEND _cmake_import_check_targets TKService )
list(APPEND _cmake_import_check_files_for_TKService "${_IMPORT_PREFIX}/./libTKService.so.7.8.2" )
...
set_target_properties(TKV3d PROPERTIES
  IMPORTED_LOCATION_RELEASE "${_IMPORT_PREFIX}/./libTKV3d.so.7.8.2"
  IMPORTED_SONAME_RELEASE "libTKV3d.so.7.8.2"
  )

list(APPEND _cmake_import_check_targets TKV3d )
list(APPEND _cmake_import_check_files_for_TKV3d "${_IMPORT_PREFIX}/./libTKV3d.so.7.8.2" )
