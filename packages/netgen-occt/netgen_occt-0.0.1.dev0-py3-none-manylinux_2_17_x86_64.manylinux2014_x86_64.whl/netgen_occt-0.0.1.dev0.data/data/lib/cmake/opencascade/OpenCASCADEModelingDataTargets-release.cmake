...
set_target_properties(TKG2d PROPERTIES
  IMPORTED_LOCATION_RELEASE "${_IMPORT_PREFIX}/./libTKG2d.so.7.8.2"
  IMPORTED_SONAME_RELEASE "libTKG2d.so.7.8.2"
  )

list(APPEND _cmake_import_check_targets TKG2d )
list(APPEND _cmake_import_check_files_for_TKG2d "${_IMPORT_PREFIX}/./libTKG2d.so.7.8.2" )
...
set_target_properties(TKG3d PROPERTIES
  IMPORTED_LOCATION_RELEASE "${_IMPORT_PREFIX}/./libTKG3d.so.7.8.2"
  IMPORTED_SONAME_RELEASE "libTKG3d.so.7.8.2"
  )

list(APPEND _cmake_import_check_targets TKG3d )
list(APPEND _cmake_import_check_files_for_TKG3d "${_IMPORT_PREFIX}/./libTKG3d.so.7.8.2" )
...
set_target_properties(TKGeomBase PROPERTIES
  IMPORTED_LOCATION_RELEASE "${_IMPORT_PREFIX}/./libTKGeomBase.so.7.8.2"
  IMPORTED_SONAME_RELEASE "libTKGeomBase.so.7.8.2"
  )

list(APPEND _cmake_import_check_targets TKGeomBase )
list(APPEND _cmake_import_check_files_for_TKGeomBase "${_IMPORT_PREFIX}/./libTKGeomBase.so.7.8.2" )
...
set_target_properties(TKBRep PROPERTIES
  IMPORTED_LOCATION_RELEASE "${_IMPORT_PREFIX}/./libTKBRep.so.7.8.2"
  IMPORTED_SONAME_RELEASE "libTKBRep.so.7.8.2"
  )

list(APPEND _cmake_import_check_targets TKBRep )
list(APPEND _cmake_import_check_files_for_TKBRep "${_IMPORT_PREFIX}/./libTKBRep.so.7.8.2" )
