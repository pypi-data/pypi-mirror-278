...
class UpdateConnector(BrynQ):
    ...
    def new_employee_with_first_contract(self, data: dict, overload_fields: dict = None) -> requests.Response:
        ...
        fields_to_update_employee.update({"PwEm": data['email_password']}) if 'employee_blocked' in data else fields_to_update_employee
        ...
        # Update the request body with update fields
        body['AfasEmployee']['Element']['Objects']['KnPerson']['KnBasicAddressPad']['Element']['Fields'].update(fields_to_update_person)
        ...
        # Update the request body with update fields
        body['AfasEmployee']['Element']['Objects']['KnPerson']['Element']['Objects']['KnBasicAddressPad']['Element']['Fields'].update(fields_to_update_address)
