...
class UpdateConnector(BrynQ):
    ...
    def update_agencies(self, data: dict) -> requests.Response:
        ...
        """
        allowed_fields = ['employee_id', 'agency_id', 'start_date']
        required_fields = ['end_date', "instantie", "einddatum", "soort_inkomstenverhouding", "aard_arbeidsverhouding", "tabelkleur", "tabelcode", "loonheffingskorting",
