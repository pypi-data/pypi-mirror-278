...
class UpdateConnector(BrynQ):
    ...
    def update_timetable(self, data: dict, overload_fields: dict = None, method="PUT") -> requests.Response:
        ...
        allowed_fields = {
            "DaBg": "start_date_schedule",
            "DvSn": "employment_number",
            "SeNo": "standard_schedule",
            "EtTy": "type_of_schedule",
            "StIn": "suspension_hours_type",
            "DfHo": "deviation_hours_per_week_report",
            "StPa": "variable_work_pattern",
            "Spec": "variable_work_pattern_with_schedule",
            "PtDu": "flexible_working_hours",
            "DyWk": "days_per_week",
            "HrWk": "hours_per_week",
            "AhWk": "leave_build_up_per_week",
            "TbSu": "start_time_sunday",
            "TeSu": "end_time_sunday",
            "PsSu": "break_duration_sunday",
            "TbMo": "start_time_monday",
            "TeMo": "end_time_monday",
            "PsMo": "break_duration_monday",
            "TbTu": "start_time_tuesday",
            "TeTu": "end_time_tuesday",
            "PsTu": "break_duration_tuesday",
            "TbWe": "start_time_wednesday",
            "TeWe": "end_time_wednesday",
            "PsWe": "break_duration_wednesday",
            "TbTh": "start_time_thursday",
            "TeTh": "end_time_thursday",
            "PsTh": "break_duration_thursday",
            "TbFr": "start_time_friday",
            "TeFr": "end_time_friday",
            "PsFr": "break_duration_friday",
            "TbSa": "start_time_saturday",
            "TeSa": "end_time_saturday",
            "PsSa": "break_duration_saturday",
            "PcPt": "part_time_percentage",
            "WdSu": "sunday_working_day",
            "WdMo": "monday_working_day",
            "WdTu": "tuesday_working_day",
            "WdWe": "wednesday_working_day",
            "WdTh": "thursday_working_day",
            "WdFr": "friday_working_day",
            "WdSa": "saturday_working_day",
            "FtSv": "five_sv_days",
            "ClAg": "on_call_contract",
            "CIAg": "on_call_contract",
            "Immc": "apply_min_max_contract_in_payroll",
            "HrMn": "minimum_hours_per_week",
            "HrMx": "maximum_hours_per_week",
            "YrHr": "annual_hours_standard",
            "HrPm": "minimum_hours_per_period",
            "HrPr": "hours_commitment",
            "Ft": "fte",
            "FtSu": "fte_sunday",
            "FtMo": "fte_monday",
            "FtTu": "fte_tuesday",
            ...
            "HrMo": "hours_monday",
            "HrTu": "hours_tuesday",
            "HrWe": "hours_wednesday",
            "HrTh": "hours_thursday",
            "HrFr": "hours_friday",
            "HrSa": "hours_saturday",
            "FtBp": "bapo_fte",
            "FtSb": "save_bapo_fte",
            "ReRa": "remuneration_percentage",
            "ReWt": "reorganization_working_hours",
            "IrEm": "irregular_employment",
            "InPt": "involuntary_part_time",
            "CoWo": "work_schedule_code",
            "CDoc": "c_documents",
            "Cl42": "cao_42",
            "ShRe": "shift_night_reduction",
            "WrNu": "work_recovery_counter",
            "WrDe": "work_recovery_denominator",
            "WrRe": "work_recovery_scheme",
            "ReCo": "regularity_code",
            "PlaFaSn": "child",
            "PlaPhWk": "parental_leave_hours_per_week",
            "PlaViTy": "parental_leave_form_be",
            "PlaAmBl": "number_of_blocks_be",
            "PlaVaDl": "parental_leave_distribution_type",
            "PlaPerc": "paid_parental_leave_percentage",
            "PlaPlDe": "planned_end_date_parental_leave",
            "PhMo": "parental_leave_hours_monday",
            "PhTu": "parental_leave_hours_tuesday",
            "PhWe": "parental_leave_hours_wednesday",
            "PhTh": "parental_leave_hours_thursday",
            "PhFr": "parental_leave_hours_friday",
            "PhSa": "parental_leave_hours_saturday",
            "PhSu": "parental_leave_hours_sunday",
            "PfMo": "parental_leave_fte_monday",
            "PfTu": "parental_leave_fte_tuesday",
            "PfWe": "parental_leave_fte_wednesday",
            "PfTh": "parental_leave_fte_thursday",
            "PfFr": "parental_leave_fte_friday",
            "PfSa": "parental_leave_fte_saturday",
            "PfSu": "parental_leave_fte_sunday"
        }

        # Fields workschedule (Optional: If one field is given, all fields are required)
        fields_workschedule = ['startdate_workcycle', 'workcycle', 'start_week', 'index_number']

        self.__check_fields(data=data, required_fields=required_fields, allowed_fields=list(allowed_fields.values()))
        ...
        for field in (allowed_fields.values() & data.keys()):
    ...
    def new_employee_with_first_contract(self, data: dict, overload_fields: dict = None) -> requests.Response:
        ...
        allowed_fields = allowed_fields_person + allowed_fields_function + allowed_fields_salary + allowed_fields_schedule + allowed_fields_contract + allowed_fields_address
