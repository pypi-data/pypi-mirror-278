...
def python_carnet(env:BaseMaestro):
...
def python_ide(env:BaseMaestro):
...
def html_fig(env:BaseMaestro):
    ...
    def wrapped(num: int) -> str:
        ...
        # NON TESTÉ !
        fig_html = get_sibling_of_current_page(env, f'figures/fig_{ num }.html', rel_to_docs=True)
