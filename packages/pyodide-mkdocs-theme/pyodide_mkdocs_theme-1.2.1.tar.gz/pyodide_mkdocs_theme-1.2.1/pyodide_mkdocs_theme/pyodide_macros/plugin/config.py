...
class BuildConfig(CopyableConfig):
    ...
    * A warning will be emitted, unless it's the default directory that is missing (`#!py 'py_libs'`).
    * The libraries have to be ___directories___ in the project directory (_not_ the docs_dir).
    ...
    will automatically converted using this number of spaces.
    _There are NO guarantees about the correctness of the result_.

    If a conversion is done, a warning will be shown in the console to modify the problematic call.
    """
