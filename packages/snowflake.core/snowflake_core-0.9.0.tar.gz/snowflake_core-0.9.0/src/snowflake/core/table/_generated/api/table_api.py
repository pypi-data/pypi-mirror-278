...
class TableApi(object):
    ...
    def resume_recluster(
        ...
        """
        kwargs['_return_http_data_only'] = True
        return self.resume_recluster_with_http_info(database, var_schema, name,
                                                    if_exists,
                                                    **kwargs)  # noqa: E501
    ...
    def suspend_recluster(
        ...
        """
        kwargs['_return_http_data_only'] = True
        return self.suspend_recluster_with_http_info(database, var_schema,
                                                     name, if_exists,
                                                     **kwargs)  # noqa: E501
    ...
    def swap_with(
        ...
        """
        kwargs['_return_http_data_only'] = True
        return self.swap_with_with_http_info(database, var_schema, name,
                                             target_table_name, if_exists,
                                             **kwargs)  # noqa: E501

    @validate_call
    def swap_with_with_http_info(
            self,
            database:
        Annotated[
            str,
