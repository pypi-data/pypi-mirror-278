...
class SchemaApi(object):
    ...
    def clone_schema(
        ...
        >>> thread = api.clone_schema(database, name, schema_clone, create_mode, kind, async_req=True)
        >>> result = thread.get()
        :param database: Identifier (i.e. name) for the database to which the resource belongs. You can use the `/api/v2/databases` GET request to get a list of available databases. (required)
        :type database: str
        :param name: Identifier (i.e. name) for the resource. (required)
    ...
    def clone_schema_with_http_info(
        ...
        >>> thread = api.clone_schema_with_http_info(database, name, schema_clone, create_mode, kind, async_req=True)
        >>> result = thread.get()
        :param database: Identifier (i.e. name) for the database to which the resource belongs. You can use the `/api/v2/databases` GET request to get a list of available databases. (required)
        :type database: str
        :param name: Identifier (i.e. name) for the resource. (required)
