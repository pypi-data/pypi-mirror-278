...
class User(BaseModel):
    ...
    __properties = [
        ...
        "rsa_public_key_2", "rsa_public_key_2_fp", "comment", "created_on",
        "last_successful_login", "expires_at", "locked_until", "has_password",
        "has_rsa_public_key", "ext_authn_duo", "ext_authn_uid", "owner",
