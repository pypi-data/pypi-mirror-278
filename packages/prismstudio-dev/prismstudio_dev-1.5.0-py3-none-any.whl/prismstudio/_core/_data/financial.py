...
class balance_sheet(_PrismFinancialDataComponent):
    ...
    --------
        ...
        >>> ta = prism.financial.balance_sheet(dataitemid=100033, period_type='Q')
...
class cash_flow(_PrismFinancialDataComponent):
    ...
    --------
        ...
        >>> fps = prism.financial.cash_flow(dataitemid=100506, period_type='LTM')
...
class dps(_PrismFinancialDataComponent):
    ...
    --------
        ...
        >>> dps = prism.financial.dps(dataitemid=100549, period_type='LTM')
...
class eps(_PrismFinancialDataComponent):
    ...
    --------
        ...
        >>> eps = prism.financial.eps(dataitemid=100567, period_type='LTM')
...
class income_statement(_PrismFinancialDataComponent):
    ...
    --------
        ...
        >>> ni = prism.financial.income_statement(dataitemid=100639, period_type='LTM')
...
class segment(_PrismFinancialDataComponent):
    ...
    --------
        ...
        >>> seg = prism.financial.segment(104731, period_type='Q')
...
class ratio(_PrismFinancialDataComponent):
    ...
    --------
        ...
        >>> rat = prism.financial.ratio(112907, period_type='Q')
...
class commitment(_PrismFinancialDataComponent):
    ...
    --------
        ...
        >>> com = prism.financial.commitment(104830, period_type='Q')
...
class pension(_PrismFinancialDataComponent):
    ...
    --------
        ...
        >>> pen = prism.financial.pension(104830, period_type='Q')
...
class option(_PrismFinancialDataComponent):
    ...
    --------
        ...
        >>> opt = prism.financial.pension(100668, period_type='Q')
