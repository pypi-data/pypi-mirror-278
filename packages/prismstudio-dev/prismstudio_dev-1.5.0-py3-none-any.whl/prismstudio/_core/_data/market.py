...
class close(_PrismMarketComponent):
    ...
    --------
        ...
        >>> close = prism.market.close(adjustment=True, package='Prism Market')
...
class high(_PrismMarketComponent):
    ...
    Examples
    --------
        >>> high = prism.market.high(adjustment=True, package='Prism Market')
...
class low(_PrismMarketComponent):
    ...
    Examples
    --------
        >>> low = prism.market.low(adjustment=True, package='Prism Market')
...
class ask(_PrismMarketComponent):
    ...
    Examples
    --------
        >>> ask = prism.market.ask(adjustment=True, package='Prism Market')
...
class bid(_PrismMarketComponent):
    ...
    Examples
    --------
        >>> bid = prism.market.bid(adjustment=True, package='Prism Market')
...
class vwap(_PrismMarketComponent):
    ...
    Examples
    --------
        >>> vwap = prism.market.ask(adjustment=True, package='CIQ Market')
