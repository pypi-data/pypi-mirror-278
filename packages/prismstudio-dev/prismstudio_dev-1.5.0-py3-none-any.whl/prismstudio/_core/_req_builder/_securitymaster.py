...
def get_securitymaster(attribute: str, search: str):
    ...
    Examples
    --------
        >>> prism.get_securitymaster(attribute='companyname', search='Samsung')
...
def get_securitymaster_advanced(queries: list):
    ...
    Examples
    --------
        >>> prism.get_securitymaster_advanced([{'attribute': 'country', 'search': 'US'}, {'attribute': 'GICS sector', 'search': '30'}])
                listingid      valuetype     value   startdate     enddate
