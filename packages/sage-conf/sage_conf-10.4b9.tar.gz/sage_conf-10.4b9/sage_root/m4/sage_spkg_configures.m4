...
m4_sinclude([build/pkgs/sbcl/spkg-configure.m4])
...
SAGE_SPKG_FINALIZE([pyproject_hooks], [standard], [normal], [SAGE_VENV])
...
SAGE_SPKG_FINALIZE([python_build], [standard], [normal], [SAGE_VENV])
