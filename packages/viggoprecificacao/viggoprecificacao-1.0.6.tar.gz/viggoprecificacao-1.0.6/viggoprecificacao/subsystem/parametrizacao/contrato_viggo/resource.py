...
class ContratoViggo(entity.Entity, db.Model):
    ...
    attributes = ['plano_id', 'codigo', 'observacao', 'dias_pagamento',
                  ...
                  'customizado']
    read_only_attributes = ['v_total_produtos']
    ...
    domain = orm.relationship('Domain', backref=orm.backref(
        'contrato_viggo_domain'))
