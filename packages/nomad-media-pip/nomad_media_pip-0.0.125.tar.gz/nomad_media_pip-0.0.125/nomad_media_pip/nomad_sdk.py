...
class Nomad_SDK:
	...
	ROUTE_ITEM_NAME (string | None): The name of the route item. This is used to create the route
	...
	def update_content_definition(self, ID: str, NAME: str | None, CONTENT_FIELDS: List[dict] | None,
								  ...
								  DISPLAY_FIELD: str | None, ROUTE_ITEM_NAME: str | None, 
		...
		try:
			...
			_update_content_definition(self, self.token, self.config["serviceApiUrl"], ID, NAME, 
				...
				ROUTE_ITEM_NAME, SECURITY_GROUPS, SYSTEM_ROLES, INCLUDE_IN_TAGS, INDEX_CONTENT, 
				self.debug_mode)
