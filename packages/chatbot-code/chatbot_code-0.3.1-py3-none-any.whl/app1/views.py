        ...
        def get_response(file_id, relevant_text, question, stop_sequences=["<end>", "</s>", "</n>"], max_attempts=3):
            ...
            payload = {
                ...
                "parameters": {
                    ...
                    "max_new_tokens": 300,   # Increase max tokens to ensure enough length
            ...
            try:
                ...
                for attempt in range(max_attempts):
                    # response = query_sagemaker_endpoint("Enter Your Endpoint Here", payload)
                    response = query_sagemaker_endpoint(SAGEMAKER_ENDPOINT_NAME, payload)
