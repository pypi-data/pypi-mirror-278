...
setup(
    name='chatbot-code',
    version='110.8',  # Ensure this line has only the version number as a string
    packages=find_packages(),
    include_package_data=True,
    install_requires=[
        # 'Django>=3.2,<4.0',
    ...
    package_data={
        '': ['*.html', '*.css', '*.js', 'manage.py', 'requirements.txt', 'README.md'],  # Include all templates and static files
