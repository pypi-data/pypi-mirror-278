...
class PageToolResponse(BaseModel):
    """
    PageToolResponse
    """

    items: conlist(ToolResponse) = Field(...)
    total: Total = Field(...)
    page: Page = Field(...)
    size: Size = Field(...)
    ...
    @classmethod
    def from_json(cls, json_str: str) -> PageToolResponse:
        """Create an instance of PageToolResponse from a JSON string"""
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> PageToolResponse:
