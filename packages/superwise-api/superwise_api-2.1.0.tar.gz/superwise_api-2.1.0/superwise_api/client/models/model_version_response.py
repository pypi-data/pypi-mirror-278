...
MODELVERSIONRESPONSE_ANY_OF_SCHEMAS = ["GoogleModelVersion", "OpenAIModelVersion", "str"]
...
class ModelVersionResponse(BaseModel):
    ...
    if TYPE_CHECKING:
        ...
        actual_instance: Any
    any_of_schemas: List[str] = Field(MODELVERSIONRESPONSE_ANY_OF_SCHEMAS, const=True)
    ...
    def actual_instance_must_validate_anyof(cls, v):
        instance = ModelVersionResponse.construct()
        error_messages = []
        ...
        if error_messages:
            # no match
            raise ValueError(
                "No match found when setting the actual_instance in ModelVersionResponse with anyOf schemas: GoogleModelVersion, OpenAIModelVersion, str. Details: "
                + ", ".join(error_messages)
            )
        else:
            return v
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> ModelVersionResponse:
        return cls.from_json(json.dumps(obj))

    @classmethod
    def from_json(cls, json_str: str) -> ModelVersionResponse:
        ...
        if error_messages:
            # no match
            raise ValueError(
                "No match found when deserializing the JSON string into ModelVersionResponse with anyOf schemas: GoogleModelVersion, OpenAIModelVersion, str. Details: "
                + ", ".join(error_messages)
            )
        else:
            return instance
