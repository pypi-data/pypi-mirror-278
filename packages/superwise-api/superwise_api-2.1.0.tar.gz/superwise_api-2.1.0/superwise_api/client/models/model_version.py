...
MODELVERSION_ANY_OF_SCHEMAS = ["GoogleModelVersion", "OpenAIModelVersion", "str"]
...
class ModelVersion(BaseModel):
    ...
    def actual_instance_must_validate_anyof(cls, v):
        ...
        if error_messages:
            # no match
            raise ValueError(
                "No match found when setting the actual_instance in ModelVersion with anyOf schemas: GoogleModelVersion, OpenAIModelVersion, str. Details: "
                + ", ".join(error_messages)
            )
        else:
            return v
    ...
    def from_json(cls, json_str: str) -> ModelVersion:
        ...
        if error_messages:
            # no match
            raise ValueError(
                "No match found when deserializing the JSON string into ModelVersion with anyOf schemas: GoogleModelVersion, OpenAIModelVersion, str. Details: "
                + ", ".join(error_messages)
            )
        else:
            return instance
