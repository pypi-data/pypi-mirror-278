...
class PageModelResponse(BaseModel):
    ...
    items: conlist(ModelResponse) = Field(...)
    total: Total = Field(...)
    page: Page = Field(...)
    size: Size = Field(...)
    ...
    @classmethod
    def from_json(cls, json_str: str) -> PageModelResponse:
        """Create an instance of PageModelResponse from a JSON string"""
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> PageModelResponse:
        """Create an instance of PageModelResponse from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return PageModelResponse.parse_obj(obj)

        _obj = PageModelResponse.parse_obj(
            {
                "items": [ModelResponse.from_dict(_item) for _item in obj.get("items")]
