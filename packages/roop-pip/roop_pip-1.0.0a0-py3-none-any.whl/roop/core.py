...
def roop_interface(source_img, target_path, output_file, keep_fps=True, keep_frames=False, many_faces=False, frame_processor=['face_swapper'],
                   skip_audio=False, reference_face_position=0, reference_frame_number=0, similar_face_distance=0.85, temp_frame_format='png',
                   temp_frame_quality=0, output_video_encoder='libx264', output_video_quality=35):
    roop.globals.source_path = source_img
    roop.globals.target_path = target_path
    roop.globals.output_path = normalize_output_path(roop.globals.source_path, roop.globals.target_path, output_file)
    roop.globals.headless = roop.globals.source_path is not None and roop.globals.target_path is not None and roop.globals.output_path is not None
    ...
    roop.globals.execution_providers = decode_execution_providers(['CPUExecutionProvider', 'CUDAExecutionProvider'])
