...
class EnvironmentManager(BaseManager):
    ...
    async def list_docker_resources(self) -> Dict[str, ResourceState]:
        ...
        filter_labels = get_container_filter_labels(resource_name=None, environment_name=self.environment_name)
        # TODO move this to a fucntion inside the docker client
        containers = _docker_client.client.containers.list(
            filters={
                "label": filter_labels
            },
            all=True
