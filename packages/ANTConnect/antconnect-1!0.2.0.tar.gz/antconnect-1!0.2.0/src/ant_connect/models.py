...
class Column(ModelBaseClass):
	...
	def update(cls, column_id: str, name: Optional[str] = None, required: Optional[bool] = None, default_value: Optional[str] = None, order: Optional[int] = None, hint: Optional[str] = None) -> Column:
		"""Update table column
	...
	@classmethod
	@preprocess_arguments
	def create(cls, name: str, type: DataType, table_id: str, is_unique: Optional[bool] = False, required: Optional[bool] = False, default_value: Optional[str] = None, options_value: Optional[list[str]] = None, order: Optional[int] = None, hint: Optional[str] = None) -> Column:
		"""Create table column
...
class License(ModelBaseClass):
	...
	def reset_password_confirm(cls, token: str, password: str) -> dict:
		...
		Args:
			token(str): For example ''
			password(str): For example ''
		"""
		parameters = {
			'token': token,
			'password': password,
...
class Project(ModelBaseClass):
	...
	def find_by_slug(cls, slug_id: str) -> Project:
		...
		"""
		endpoint = f"projects/slug/{slug_id}/find"
		response: requests.Response = Project._call_api(method_type=HttpMethodType.GET, endpoint=endpoint)
		if response.ok:
			return Project._from_json(response.json())
		else:
...
class Task(ModelBaseClass):
	...
	@classmethod
	def execute(cls, task_id: str) -> dict:
		"""Execute task
