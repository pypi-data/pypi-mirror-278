...
from .Parse import (TypeDeclaration, Declaration, SymbolDeclaration,
...
class Theory(object):
    ...
    def optimize(self,
        ...
        assert (len(decl.codomain.root_set) == 1
                and decl.codomain.root_set[0] in (INT_SETNAME, REAL_SETNAME)), (
