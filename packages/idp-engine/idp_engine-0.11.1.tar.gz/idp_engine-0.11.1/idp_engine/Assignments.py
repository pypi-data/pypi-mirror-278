...
from .Expression import (Expression, TRUE, FALSE, AND, NOT, EQUALS, AppliedSymbol,
                         SetName, BOOL_SETNAME, DATE_SETNAME, INT_SETNAME, REAL_SETNAME,
                         Number)
...
def str_to_IDP(val_string: str,
    ...
    """
    if (hasattr(type_.root_set[0].decl, 'map')
