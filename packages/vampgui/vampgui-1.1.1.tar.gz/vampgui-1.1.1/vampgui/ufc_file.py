...
# Frame for buttons
    ...
    def generate_ucf_file(self):
        ...
        try:
            number_of_interactions = int(self.number_of_interactions_entry.get())
        except ValueError:
            messagebox.showerror("Error", "Please enter a valid number of interactions.")
            return
        try:
        ...
        messagebox.showinfo("Success", f"{filename} has been generated.\n interaction parameters (id i j dx dy dz Jij) should be added manually.")
