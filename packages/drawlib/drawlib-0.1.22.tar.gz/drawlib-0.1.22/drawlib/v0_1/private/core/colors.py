...
class ColorsThemeDefault(ColorsBase):
    ...
    Red: Final[Tuple[int, int, int]] = (109, 124, 197)
    Green: Final[Tuple[int, int, int]] = (112, 194, 191)
    Blue: Final[Tuple[int, int, int]] = (109, 124, 197)
    Black: Final[Tuple[int, int, int]] = (193, 102, 107)
    White: Final[Tuple[int, int, int]] = (255, 255, 255)


class ColorsThemeSimple(ColorsBase):
    """Colors for theme simple"""
...
class ColorsThemeRich(ColorsBase):
    """Colors for theme rich"""
