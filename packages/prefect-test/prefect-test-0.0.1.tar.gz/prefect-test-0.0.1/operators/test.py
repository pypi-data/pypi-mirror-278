...
class YeeduOperator():
    ...
    def __init__(self, var_job_url, connection_name,sec_password, *args, **kwargs):
        """
        ...
        **kwargs: Additional keyword arguments.
        ...
        self.var_job_url = var_job_url
        self.connection_name = connection_name
        self.var_password = sec_password
    ...
    def get_url(self):
        ...
        job_url = Variable.get(self.var_job_url)
        return job_url.value
    ...
    #     json_data = JSON.load(self.var_connection_details).value
