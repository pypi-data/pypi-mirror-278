...
def execute_test_case(
    ...
    Returns:
        A tuple of the ExecutionDetails and a list of invalid
    ...
    return execution_details, invalid_quality_measures
...
def _execute_test_suite_test_case(
        ...
        A tuple of the LogTestCaseExecutionRequest and a list of invalid
            ...
            Dictionary with the following keys:
                ...
                "execution_details": wire_model.QualityMeasureExecutionDetails
                    object.
    """
    execution_details, invalid_quality_measures = execute_test_case(
    ...
    return log_execution_request, invalid_quality_measures
