...
Please report defects to the `the GitHub Tracker <https://github.com/antoinecollet5/nested_grid_plotter/issues>`_
...
If you wish to propose a feature, please file an issue on `the GitHub Tracker <https://github.com/antoinecollet5/nested_grid_plotter/issues>`_ using the **Feature** description template. Community members will help refine and design your idea until it is ready for implementation.
...
Nested Grid Plotter could always use more documentation, whether as part of the official Nested Grid Plotter docs, in docstrings, tutorials and even on the web in blog posts, articles and such.
...
After an issue is created, the progress of the issues is tracked on the `GitHub issue board <https://github.com/antoinecollet5/nested_grid_plotter/boards>`_.
The maintainers will update the state using `labels <https://github.com/antoinecollet5/nested_grid_plotter/labels>`_ .
...
If you are
Thank you very much
for your hard work in improving Nested Grid Plotter.


Setting up Nested Grid Plotter for local development
----------------------------------------------------

Ready to contribute? Here's how to set up `Nested Grid Plotter` for local development.

1. Fork the `nested_grid_plotter` repo on GitHub.
2. Clone your fork locally::

    $ git clone git@github.com:your_name_here/nested_grid_plotter.git

3. Install your local copy into a virtualenv. Assuming you have virtualenvwrapper installed, this is how you set up your fork for local development::

    $ mkvirtualenv nested_grid_plotter
...
5. When you're done making changes, check that your changes pass flake8, the tests and have test coverage::
  ...
  The docs will be located in `nested_grid_plotter/docs/build`.
...
.. tip:: Running parts of the test suite
    ...
    .. code-block:: shell
        ...
        $ py.test tests/measurement --cov nested_grid_plotter/measurement

    will look for tests located in the tests/measurement directory and report test coverage of the nested_grid_plotter/measurement module.
