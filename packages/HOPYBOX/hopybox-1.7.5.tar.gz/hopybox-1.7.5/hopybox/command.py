...
def command_data_add():
  ...
  _command_add('Device','storage',{'-t':"print(device.Storage().total(command_data['Device']['storage']['run']))",'-u':"print(device.Storage().used(command_data['Device']['storage']['run']))",'-f':"print(device.Storage().free(command_data['Device']['storage']['run']))",'-p':"print(device.Storage().percent(command_data['Device']['storage']['run']))"},['storage -t','storage -u','storage -f','storage -p'],['Used to get the total amount of storage','Used to get the storage occupied','Used to get the remaining amount of storage','Used to get the percentage of storage occupied'])
  ...
  _command_add('File','mkdir',"os.mkdir(command_data['File']['mkdir']['run'])",'worklist','To create a dir')
  _command_add('File','remove',{'-f':"os.remove(command_data['File']['remove']['run'])",'-d':"os.rmdir(command_data['File']['remove']['run'])"},['remove -f {path}','remove -d {path}'],['To remove the file','To remove the file'])
