...
class DatasetClient:
    ...
    def download_dataset(self, version_id: str, export_type: str, is_media_include: True):
        self._dataset_sync_tool.download_dataset(version_id, export_type, is_media_include)
    ...
    def download_annotations(
            ...
            operation_id_list,
            is_media_include):
        self._dataset_sync_tool.download_collection(collection_id, annotation_type, operation_id_list, is_media_include)
    ...
    if we need annotations for that specific model """
    def download_annotations_for_project_v2(self, project_id_list, status_list, is_annotated_only, is_media_include):
        self._dataset_sync_tool.download_project_v2(project_id_list, status_list, is_annotated_only, is_media_include)
