# Generated by Django 3.2.5 on 2023-08-23 10:17
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('user_name', models.CharField(blank=True, db_index=True, help_text='登录的用户名', max_length=32, null=True, unique=True, verbose_name='用户名')),
                ('nickname', models.CharField(blank=True, max_length=128, null=True, verbose_name='昵称')),
                ('full_name', models.CharField(blank=True, db_index=True, help_text='用户的姓名（未实名验证）', max_length=128, null=True, verbose_name='姓名')),
                ('phone', models.CharField(blank=True, db_index=True, help_text='登录用的手机号', max_length=128, null=True, verbose_name='手机')),
                ('email', models.EmailField(blank=True, db_index=True, help_text='登录用的邮箱', max_length=254, null=True, verbose_name='邮箱')),
                ('user_type', models.CharField(blank=True, choices=[('PERSON', '个人用户'), ('COMPANY', '企业用户'), ('ADMIN', '管理员用户')], help_text='PERSON 个人用户, COMPANY 企业用户', max_length=255, null=True, verbose_name='用户类型')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('field_index', models.CharField(blank=True, choices=[('field_1', '自定义字段1'), ('field_2', '自定义字段2'), ('field_3', '自定义字段3'), ('field_4', '自定义字段4'), ('field_5', '自定义字段5'), ('field_6', '自定义字段6'), ('field_7', '自定义字段7'), ('field_8', '自定义字段8'), ('field_9', '自定义字段9'), ('field_10', '自定义字段10'), ('field_11', '自定义字段11'), ('field_12', '自定义字段12'), ('field_13', '自定义字段13'), ('field_14', '自定义字段14'), ('field_15', '自定义字段15')], help_text='映射到扩展数据表的字段名，如：field_x', max_length=255, null=True, unique=True, verbose_name='映射索引名')),
                ('field', models.CharField(blank=True, help_text='当已有字段不能满足的时候的扩展字段', max_length=30, null=True, unique=True, verbose_name='自定义字段')),
                ('label', models.CharField(blank=True, help_text='自定义字段的标签，用于前端显示', max_length=30, null=True, unique=True, verbose_name='标签')),
                ('type', models.CharField(blank=True, choices=[('image', '图片-image'), ('text', '输入框-text'), ('plain', '禁止编辑-plain'), ('number', '数字类型-number'), ('time', ' 时间类型-time'), ('select', '选择框-select'), ('upload', '上传类型-upload'), ('textarea', '文本域-textarea'), ('password', '密码-password'), ('switch', '开关-switch'), ('radio', '视频-radio'), ('checkBox', '多选-checkBox'), ('date', '日期-date'), ('month', '月份-month'), ('year', '年-year'), ('cascader', '多选-cascader'), ('slot', '插槽-slot'), ('editor', '富文本-editor')], help_text='自定义字段的数据类型，必须和前端相匹配', max_length=255, null=True, verbose_name='类型')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('platform_code', models.CharField(help_text='必填。自动生成8为随机编码', max_length=8, unique=True, verbose_name='平台代码')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(primary_key=True, serialize=False, verbose_name='ID')),
                ('bank_card_num', models.CharField(blank=True, max_length=50, null=True, verbose_name='银行卡号')),
                ('open_account_bank', models.CharField(blank=True, max_length=50, null=True, verbose_name='开户银行')),
                ('opening_branch', models.CharField(blank=True, max_length=50, null=True, verbose_name='开户支行')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('language', models.CharField(blank=True, choices=[('cn', '简体中文'), ('en', 'English'), ('ru', 'Русский'), ('tc', '繁体中文'), ('fr', 'Français'), ('de', 'Deutsch'), ('jp', '日本語')], max_length=32, null=True, verbose_name='我使用的语言')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('algorithm', models.CharField(blank=True, choices=[('DEFAULT', 'Default'), ('DISCUZ', 'Discuz (md5(md5(pwd).salt)'), ('SPSS', 'Spss (sha1(rsa(cip).salt))')], help_text='系统同时支持多种加密算法，旧版为MD5，新版为SHA1', max_length=255, null=True, verbose_name='加密算法')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('user', models.OneToOneField(db_column='user_id', on_delete=django.db.models.deletion.DO_NOTHING, primary_key=True, serialize=False, to='xj_user.baseinfo', verbose_name='用户')),
