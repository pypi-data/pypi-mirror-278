...
# TODO: test to see if this works, we removed all unused stuff for shuttleai api like comment, event, etc.
# if it works, it should drastically increase the performance of the server sent events
