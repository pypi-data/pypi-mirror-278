...
def get_simulation_gpu_env():
    ...
    if env_enable_simulation_gpu is not None:
        enable_simulation_gpu = True if env_enable_simulation_gpu == "1" or env_enable_simulation_gpu == 1 else False

    env_simulation_gpu_count = os.getenv("FEDML_SIMULATION_GPU_COUNT", None)
    if env_simulation_gpu_count is not None:
        simulation_gpu_count = int(env_simulation_gpu_count)

    return enable_simulation_gpu, simulation_gpu_count
