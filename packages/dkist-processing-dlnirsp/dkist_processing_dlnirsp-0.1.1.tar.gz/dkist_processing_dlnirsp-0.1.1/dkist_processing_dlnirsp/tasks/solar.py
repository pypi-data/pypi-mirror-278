...
class SolarCalibration(DlnirspTaskBase, GroupIdMixin, CorrectionsMixin, QualityMixin):
    """
    ...
    def run(self) -> None:
        ...
        with self.apm_task_step("Compute characteristic spectra"):
            ...
            self.write(
                ...
                tags=[DlnirspTag.debug(), DlnirspTag.task("SC_PAD_CHAR_SPEC")],
        ...
        with self.apm_task_step("Re-distort characteristic spectra"):
            ...
            self.write(
                ...
                tags=[DlnirspTag.debug(), DlnirspTag.task("SC_CHAR_DISTORT")],
                encoder=fits_array_encoder,
            )
