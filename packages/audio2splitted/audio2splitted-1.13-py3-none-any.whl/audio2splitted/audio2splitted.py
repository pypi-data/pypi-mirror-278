...
def construct_audio_parts(
    ...
    source_audio_length = source_audio_length.__int__()
    duration_seconds = duration_seconds.__int__()
    delta_seconds = delta_seconds.__int__()
    threshold_seconds = threshold_seconds.__int__()
