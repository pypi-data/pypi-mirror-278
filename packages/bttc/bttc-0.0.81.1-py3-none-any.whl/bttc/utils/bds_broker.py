...
def require_sl4a(
  ...
  def _decorator(self, *args, **kwargs) -> Any:
    ...
    secondary_ad_services = (
        self.secondary_ad.services.list_live_services() if self.secondary_ad
        else {})
    if 'sl4a' not in secondary_ad_services:
      self.secondary_ad.log.warning(msg)
      return False
...
class Broker:
  ...
  Attributes:
    primary_ad: Simulator device.
    secondary_ad: Connected Android device.
