...
class IUrlFilteringProtection(
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["mode"], typing_extensions.Literal["enableNetworkLevelFiltering"], typing_extensions.Literal["blockMaliciousScripts"], typing_extensions.Literal["userOverrides"], typing_extensions.Literal["allowLogsForVisitedSites"], ]):
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["mode"], typing_extensions.Literal["enableNetworkLevelFiltering"], typing_extensions.Literal["blockMaliciousScripts"], typing_extensions.Literal["userOverrides"], typing_extensions.Literal["allowLogsForVisitedSites"], ]):
