        ...
        try:
            ...
            if response.status_code == 200:
                ...
                with open(output_file, 'wb') as f:
                    ...
                    return 0, "Audio saved successfully.", output_file, audio_index, speech_obj["type"]
...
def build_v3(feature_images_urls, feature_names, feature_descriptions, feature_ids, existing_audios, build_card_name, subscription_key, service_region):
    ...
    features_intro_speech_obj = {
        "text": f"Starting with the {feature_names[0]} users will be able to then interact with {feature_names[1]} and {feature_names[2]} <break time='200ms'/> ",
        "type": "feature_intro",
