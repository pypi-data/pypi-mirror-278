...
class VOCDataSet(object):
    def __init__(self, voc_root):
        ...
        self.root = voc_root
        self.annotations_root = voc_root
        ...
        self.xml_list = [os.path.join(self.annotations_root, line.strip())
                         for line in os.listdir(self.root) if '.xml' in line]

        # check file
        assert len(self.xml_list) > 0, "in '{}' file does not find any information.".format(voc_root)
