...
def main(data_dir, img_size=512, n=9, thr=0.25, gen=1000):
    # 从数据集中读取所有图片的wh以及对应bboxes的wh
    dataset = VOCDataSet(voc_root=data_dir)
...
if __name__ == "__main__":
    data_dir = r'C:\Users\Administrator\Desktop\nginx\html\download\LM_Projects\datapool\images\20240418-BW-OD-POC\onelineonemodel\C211_cropped'
    main(data_dir, img_size=640, n=9)