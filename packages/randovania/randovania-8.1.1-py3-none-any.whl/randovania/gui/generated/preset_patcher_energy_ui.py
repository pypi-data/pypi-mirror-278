...
class Ui_PresetPatcherEnergy(object):
    def setupUi(self, PresetPatcherEnergy):
        ...
        self.scroll_area_contents.setGeometry(QRect(0, 0, 455, 1264))
        ...
        self.gridLayout_51 = QGridLayout(self.ingame_difficulty_box)
        ...
        self.gridLayout_51.addWidget(self.ingame_difficulty_label, 0, 0, 1, 1)
        ...
        self.gridLayout_51.addWidget(self.ingame_difficulty_combo, 1, 0, 1, 1)
