...
from .model_definitions import roberta_model, rnn_model
import matplotlib.pyplot as plt

## take model as input and remove create_model function
def train_and_evaluate(model, model_type: str , df: pd.DataFrame, mapped_emotion_column: str, input_id_column: str, learning_rate: float, batch_size: int, num_epochs: int, patience: int = 3) -> nn.Module:
    """
    ...
    # TODO: Add if else here for roberta or tensorflow model 
    # Train the model
                    ...
                    if average_val_loss < best_val_loss:
                        ...
                        if epochs_no_improve >= patience:
                            ...
                            try:
                                ...
                                logger.error('Error while plotting and saving learning curves: %s', e)
                                raise
